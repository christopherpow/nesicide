...
class rcDialogEx(object):
   ...
   def output_dialog_item(self,idx,item):
      if item.generic_control_statement():
         self.output_generic_control_statement(idx,item.generic_control_statement())
      elif item.static_control_statement():
         self.output_static_control_statement(idx,item.static_control_statement())
      elif item.groupbox_control_statement():
         self.output_groupbox_control_statement(idx, item.groupbox_control_statement())
      elif item.combobox_control_statement():
         self.output_combobox_control_statement(idx, item.combobox_control_statement())
      elif item.listbox_control_statement():
         self.output_listbox_control_statement(idx, item.listbox_control_statement())
      elif item.edit_control_statement():
         self.output_edit_control_statement(idx, item.edit_control_statement())
      elif item.button_control_statement():
         self.output_button_control_statement(idx, item.button_control_statement())
      elif item.defpushbutton_control_statement():
         self.output_defpushbutton_control_statement(idx, item.defpushbutton_control_statement())
