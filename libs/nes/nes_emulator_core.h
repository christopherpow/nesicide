...
#define SCANLINES_TOTAL_DENDY (SCANLINES_VISIBLE+SCANLINES_VBLANK_NTSC+SCANLINES_QUIET_DENDY+1)
...
#define PPU_CYCLE_END_VBLANK_DENDY ((SCANLINES_VISIBLE+SCANLINES_QUIET_DENDY+SCANLINES_VBLANK_NTSC)*PPU_CYCLES_PER_SCANLINE)
