...
uint8_t  CROMMapper022::m_reg [] = { 0x00, };
uint8_t  CROMMapper022::m_chr [];
...
void CROMMapper022::HMAPPER ( uint32_t addr, uint8_t data )
{
   ...
   case 0x8003:
      reg = 0;
      m_reg[0] = data;
      m_pPRGROMmemory[0] = m_PRGROMmemory[data&0x0F];
      break;
   case 0x9000:
   case 0x9001:
   case 0x9002:
   ...
   case 0xA003:
      reg = 2;
      m_reg[2] = data;
      m_pPRGROMmemory[1] = m_PRGROMmemory[data&0x0F];
      break;
   case 0xB000:
      reg = 3;
      m_reg[3] = data;
      m_chr[0] &= 0xF0;
      m_chr[0] |= (data&0x0F);
      m_pCHRmemory[0] = m_CHRmemory[m_chr[0]>>1]; // NOTE: >>1 VRC2a only
      break;
   case 0xB001:
      reg = 4;
      m_reg[4] = data;
      ...
      m_pCHRmemory[1] = m_CHRmemory[m_chr[1]>>1]; // NOTE: >>1 VRC2a only
      break;
   case 0xB002:
      reg = 5;
      m_reg[5] = data;
   ...
   case 0xC000:
      ...
      m_chr[2] &= 0xF0;
      m_chr[2] |= (data&0x0F);
      m_pCHRmemory[2] = m_CHRmemory[m_chr[2]>>1]; // NOTE: >>1 VRC2a only
      break;
   case 0xC001:
      reg = 8;
      m_reg[8] = data;
      ...
      m_pCHRmemory[3] = m_CHRmemory[m_chr[3]>>1]; // NOTE: >>1 VRC2a only
      break;
   case 0xC002:
      reg = 9;
      m_reg[9] = data;
   ...
   case 0xD000:
      ...
      m_chr[4] &= 0xF0;
      m_chr[4] |= (data&0x0F);
      m_pCHRmemory[4] = m_CHRmemory[m_chr[4]>>1]; // NOTE: >>1 VRC2a only
      break;
   case 0xD001:
      reg = 12;
      m_reg[12] = data;
      ...
      m_pCHRmemory[5] = m_CHRmemory[m_chr[5]>>1]; // NOTE: >>1 VRC2a only
      break;
   case 0xD002:
      reg = 13;
      m_reg[13] = data;
   ...
   case 0xE000:
      ...
      m_chr[6] &= 0xF0;
      m_chr[6] |= (data&0x0F);
      m_pCHRmemory[6] = m_CHRmemory[m_chr[6]>>1]; // NOTE: >>1 VRC2a only
      break;
   case 0xE001:
      reg = 16;
      m_reg[16] = data;
      ...
      m_pCHRmemory[7] = m_CHRmemory[m_chr[7]>>1]; // NOTE: >>1 VRC2a only
      break;
   case 0xE002:
      reg = 17;
      m_reg[17] = data;
