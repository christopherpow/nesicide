...
static CRegisterData* tblRegisters [] =
{
   ...
   new CRegisterData(0x9001, "Pulse1 Frequency MSN", nesMapperHighRead, nesMapperHighWrite, 2, tbl9001Bitfields),
   new CRegisterData(0x9002, "Pulse1 Frequency LSB", nesMapperHighRead, nesMapperHighWrite, 1, tbl9002Bitfields),
   new CRegisterData(0xA000, "Pulse2 Control", nesMapperHighRead, nesMapperHighWrite, 3, tbl9000Bitfields),
   new CRegisterData(0xA001, "Pulse2 Frequency MSN", nesMapperHighRead, nesMapperHighWrite, 2, tbl9001Bitfields),
   new CRegisterData(0xA002, "Pulse2 Frequency LSB", nesMapperHighRead, nesMapperHighWrite, 1, tbl9002Bitfields),
   new CRegisterData(0xB000, "Sawtooth Control", nesMapperHighRead, nesMapperHighWrite, 3, tblB000Bitfields),
   new CRegisterData(0xB001, "Sawtooth Frequency MSN", nesMapperHighRead, nesMapperHighWrite, 2, tbl9001Bitfields),
   new CRegisterData(0xB002, "Sawtooth Frequency LSB", nesMapperHighRead, nesMapperHighWrite, 1, tbl9002Bitfields),
   ...
   new CRegisterData(0xD001, "CHR Control 2", nesMapperHighRead, nesMapperHighWrite, 1, tblD000Bitfields),
   new CRegisterData(0xD002, "CHR Control 1", nesMapperHighRead, nesMapperHighWrite, 1, tblD000Bitfields),
   ...
   new CRegisterData(0xE001, "CHR Control 6", nesMapperHighRead, nesMapperHighWrite, 1, tblD000Bitfields),
   new CRegisterData(0xE002, "CHR Control 5", nesMapperHighRead, nesMapperHighWrite, 1, tblD000Bitfields),
   ...
   new CRegisterData(0xF001, "IRQ Acknowledge", nesMapperHighRead, nesMapperHighWrite, 1, tblF001Bitfields),
   new CRegisterData(0xF002, "IRQ Control", nesMapperHighRead, nesMapperHighWrite, 3, tblF002Bitfields)
};
...
uint8_t  CROMMapper026::m_reg [] = { 0x00, };
uint8_t  CROMMapper026::m_chr [];
uint8_t  CROMMapper026::m_irqReload = 0;
uint8_t  CROMMapper026::m_irqCounter = 0;
uint8_t  CROMMapper026::m_irqPrescaler = 0;
uint8_t  CROMMapper026::m_irqPrescalerPhase = 0;
bool     CROMMapper026::m_irqEnabled = false;
...
void CROMMapper026::RESET ( bool soft )
{
   m_mapper = 26;
...
uint32_t CROMMapper026::DEBUGINFO ( uint32_t addr )
{
   switch ( addr )
   {
   case 0x8000:
...
void CROMMapper026::HMAPPER ( uint32_t addr, uint8_t data )
{
   uint32_t reg = 0;
