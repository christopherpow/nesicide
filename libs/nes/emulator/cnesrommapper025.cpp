...
static CRegisterData* tblRegisters [] =
{
   ...
   new CRegisterData(0x9002, "PRG Swap Mode", nesMapperHighRead, nesMapperHighWrite, 1, tbl9004Bitfields),
   ...
   new CRegisterData(0xF001, "IRQ Control", nesMapperHighRead, nesMapperHighWrite, 3, tblF004Bitfields),
   new CRegisterData(0xF002, "IRQ Latch HSN", nesMapperHighRead, nesMapperHighWrite, 1, tblF002Bitfields),
   new CRegisterData(0xF003, "IRQ Acknowledge", nesMapperHighRead, nesMapperHighWrite, 1, tblF006Bitfields),
   new CRegisterData(0x8000, "PRG Control 0", nesMapperHighRead, nesMapperHighWrite, 1, tbl8000Bitfields),
   new CRegisterData(0x9000, "Mirroring", nesMapperHighRead, nesMapperHighWrite, 1, tbl9000Bitfields),
   new CRegisterData(0x9008, "PRG Swap Mode", nesMapperHighRead, nesMapperHighWrite, 1, tbl9004Bitfields),
   new CRegisterData(0xA000, "PRG Control 1", nesMapperHighRead, nesMapperHighWrite, 1, tbl8000Bitfields),
   new CRegisterData(0xB000, "CHR Control 0", nesMapperHighRead, nesMapperHighWrite, 1, tblB000Bitfields),
   new CRegisterData(0xB004, "CHR Control 1", nesMapperHighRead, nesMapperHighWrite, 1, tblB000Bitfields),
   new CRegisterData(0xB008, "CHR Control 0", nesMapperHighRead, nesMapperHighWrite, 1, tblB000Bitfields),
   ...
   new CRegisterData(0xC008, "CHR Control 2", nesMapperHighRead, nesMapperHighWrite, 1, tblB000Bitfields),
   ...
   new CRegisterData(0xD008, "CHR Control 4", nesMapperHighRead, nesMapperHighWrite, 1, tblB000Bitfields),
   ...
   new CRegisterData(0xE008, "CHR Control 6", nesMapperHighRead, nesMapperHighWrite, 1, tblB000Bitfields),
   ...
   new CRegisterData(0xF008, "IRQ Latch HSN", nesMapperHighRead, nesMapperHighWrite, 1, tblF002Bitfields),
   new CRegisterData(0xF00C, "IRQ Acknowledge", nesMapperHighRead, nesMapperHighWrite, 1, tblF006Bitfields)
};
...
uint8_t  CROMMapper025::m_reg [] = { 0x00, };
uint8_t  CROMMapper025::m_chr [] = { 0, };
uint8_t  CROMMapper025::m_irqReload = 0;
uint8_t  CROMMapper025::m_irqCounter = 0;
uint8_t  CROMMapper025::m_irqPrescaler = 0;
uint8_t  CROMMapper025::m_irqPrescalerPhase = 0;
bool     CROMMapper025::m_irqEnabled = false;

CROMMapper025::CROMMapper025()
{
}
...
void CROMMapper025::SYNCCPU ( void )
{
...
void CROMMapper025::HMAPPER ( uint32_t addr, uint8_t data )
{
   ...
   case 0x800C:
      ...
      if ( m_reg[2]&0x02 )
      {
         ...
         m_pPRGROMmemory[2] = m_PRGROMmemory[data%m_numPrgBanks];
      }
      else
      {
         m_pPRGROMmemory[0] = m_PRGROMmemory[data%m_numPrgBanks];
         m_pPRGROMmemory[2] = m_PRGROMmemory[m_numPrgBanks-2];
      }
      break;
   case 0x9000:
   ...
   case 0xA00C:
      reg = 3;
      m_reg[3] = data;
      m_pPRGROMmemory[1] = m_PRGROMmemory[data%m_numPrgBanks];
      break;
   case 0xB000:
      reg = 4;
      m_reg[4] = data;
