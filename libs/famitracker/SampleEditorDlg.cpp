...
//   CONTROL         "",IDC_SAMPLE,"Static",SS_WHITERECT | SS_NOTIFY | SS_SUNKEN,7,7,467,204
   ...
   MapDialogRect(&r3);
   mfc3->Create(_T(""),SS_WHITERECT | SS_NOTIFY | SS_SUNKEN | WS_VISIBLE,r3,this,IDC_SAMPLE);
...
//   PUSHBUTTON      "Play",IDC_PLAY,67,234,50,14
   ...
   MapDialogRect(&r4);
   mfc4->Create(_T("Play"),WS_VISIBLE,r4,this,IDC_PLAY);
...
//   LTEXT           "Offset: 0, Pos: 0",IDC_POS,7,217,79,11,SS_SUNKEN
   ...
   MapDialogRect(&r5);
   mfc5->Create(_T("Offset: 0, Pos: 0"),WS_VISIBLE,r5,this,IDC_POS);
...
//   PUSHBUTTON      "Delete",IDC_DELETE,239,234,50,14
   ...
   MapDialogRect(&r6);
   mfc6->Create(_T("Delete"),WS_VISIBLE,r6,this,IDC_DELETE);
...
//   PUSHBUTTON      "Tilt",IDC_TILT,292,234,50,14
   ...
   MapDialogRect(&r8);
   mfc8->Create(_T("Tilt"),WS_VISIBLE,r8,this,IDC_TILT);
...
//   LTEXT           "0 bytes",IDC_INFO,88,217,87,11,SS_SUNKEN
   ...
   MapDialogRect(&r9);
   mfc9->Create(_T("0 bytes"),SS_SUNKEN | WS_VISIBLE,r9,this,IDC_INFO);
...
//   LTEXT           "Pitch",IDC_STATIC_PITCH,123,237,19,11
   ...
   MapDialogRect(&r10);
   mfc10->Create(_T("Pitch"),WS_VISIBLE,r10,this,IDC_STATIC_PITCH);
...
//   CONTROL         "Start from 64",IDC_DELTASTART,"Button",BS_AUTOCHECKBOX | WS_TABSTOP,7,238,57,10
   ...
   MapDialogRect(&r11);
   mfc11->Create(_T("Start from 64"),BS_AUTOCHECKBOX | WS_TABSTOP | WS_VISIBLE,r11,this,IDC_DELTASTART);
