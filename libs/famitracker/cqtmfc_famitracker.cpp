...
#include "FamiTrackerDoc.h"
   ...
   void qtMfcInitDialogResource_IDD_ABOUTBOX(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         mfc0->Create(_T("Copyright (C) 2005 - 2015 jsr"),0,r0,parent,IDC_ABOUT3);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // DEFPUSHBUTTON "OK",0|WS_GROUP,228,64,50,16
         CButton* mfc1 = new CButton(parent);
         CRect r1(CPoint(228,64),CSize(50,16));
         parent->MapDialogRect(&r1);
         mfc1->Create(_T("OK"),0|WS_GROUP,r1,parent,IDOK);
         ...
         mfc2->Create(_T("* FDS sound emulator from nezplug (including a fix by rainwarrior)"),0,r2,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         mfc3->Create(_T("E-mail:"),0,r3,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         mfc6->Create(_T("Contributions:"),0,r6,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         mfc7->Create(_T("All comments and feedback are welcome\nGreets to everyone at the 2A03.org forum and everyone who has contributed with bug reports and suggestions!"),0,r7,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         mfc8->Create(_T("jsr@famitracker.com"),0|SS_NOTIFY,r8,parent,IDC_MAIL);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         mfc9->Create(_T("http://www.famitracker.com"),0|SS_NOTIFY,r9,parent,IDC_WEBPAGE);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         mfc10->Create(_T("Web:"),0,r10,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         mfc11->Create(_T("Libraries:"),0,r11,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         mfc13->Create(_T("* Fast Fourier Transform code is (C) Reliable Software"),0,r13,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         mfc14->Create(_T("* YM2413 && YM2149 emulators are written by Mitsutaka Okazaki"),0,r14,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_STATIC, "Static", BS_AUTORADIOBUTTON, 54, 271, 215, 1
          CStatic* mfc15 = new CStatic(parent);
          CRect r15(CPoint(54, 271), CSize(215, 1));
          parent->MapDialogRect(&r15);
          mfc15->Create(_T(""), 0|SS_ETCHEDHORZ, r15, parent, IDC_STATIC);
         ...
         mfc16->Create(_T("* Export plugin support by Gradualore"),0,r16,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         mfc17->Create(_T("* Icon is made by Kuhneghetz"),0,r17,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         mfc18->Create(_T("* Toolbar icons are made by ilkke"),0,r18,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_STATIC, "Static", BS_AUTORADIOBUTTON, 54, 201, 211, 1
          CStatic* mfc19 = new CStatic(parent);
          CRect r19(CPoint(54, 201), CSize(211, 1));
          parent->MapDialogRect(&r19);
          mfc19->Create(_T(""), 0|SS_ETCHEDHORZ, r19, parent, IDC_STATIC);
         ...
         mfc20->Create(_T("* DPCM import resampler by Jarhmander"),0,r20,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         mfc21->Create(_T("A Famicom/NES music tracker"),0|SS_NOPREFIX,r21,parent,IDC_ABOUT2);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         mfc22->Create(_T("* Module text import/export by rainwarrior"),0,r22,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_STATIC, "Static", BS_AUTORADIOBUTTON, 0, 49, 287, 1
          CStatic* mfc23 = new CStatic(parent);
          CRect r23(CPoint(0, 49), CSize(287, 1));
          parent->MapDialogRect(&r23);
          mfc23->Create(_T(""), 0|SS_ETCHEDHORZ, r23, parent, IDC_STATIC);
         ...
         mfc24->Create(_T("A Famicom/NES music tracker"),0|SS_NOPREFIX,r24,parent,IDC_ABOUT1);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_HEAD, "Static", BS_AUTORADIOBUTTON, 0, 0, 287, 49
          CStatic* mfc25 = new CStatic(parent);
          CRect r25(CPoint(0, 0), CSize(287, 49));
          parent->MapDialogRect(&r25);
          mfc25->Create(_T(""), 0|SS_OWNERDRAW, r25, parent, IDC_HEAD);
   ...
   void qtMfcInitDialogResource_IDD_MAINFRAME(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("Song settings"),0,r0,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r1);
         mfc1->Create(_T("Speed"),0,r1,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // EDITTEXT IDC_SPEED,43,15,38,12,0|ES_NUMBER
         CEdit* mfc2 = new CEdit(parent);
         CRect r2(CPoint(43,15),CSize(38,12));
         parent->MapDialogRect(&r2);
         mfc2->Create(0|ES_NUMBER,r2,parent,IDC_SPEED);
         mfcToQtWidget->insert(IDC_SPEED,mfc2);
       

          // CONTROL "", IDC_SPEED_SPIN, "msctls_updown32", BS_AUTORADIOBUTTON, 81, 15, 11, 13
          CSpinButtonCtrl* mfc3 = new CSpinButtonCtrl(parent);
          CRect r3(CPoint(81, 15), CSize(11, 13));
          parent->MapDialogRect(&r3);
          mfc3->Create(0|UDS_ARROWKEYS, r3, parent, IDC_SPEED_SPIN);
         ...
         parent->MapDialogRect(&r4);
         mfc4->Create(_T("Tempo"),0,r4,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // EDITTEXT IDC_TEMPO,43,29,38,12,0|ES_READONLY
         CEdit* mfc5 = new CEdit(parent);
         CRect r5(CPoint(43,29),CSize(38,12));
         parent->MapDialogRect(&r5);
         mfc5->Create(0|ES_READONLY,r5,parent,IDC_TEMPO);
         mfcToQtWidget->insert(IDC_TEMPO,mfc5);
       

          // CONTROL "", IDC_TEMPO_SPIN, "msctls_updown32", BS_AUTORADIOBUTTON, 81, 28, 11, 13
          CSpinButtonCtrl* mfc6 = new CSpinButtonCtrl(parent);
          CRect r6(CPoint(81, 28), CSize(11, 13));
          parent->MapDialogRect(&r6);
          mfc6->Create(0|UDS_ARROWKEYS, r6, parent, IDC_TEMPO_SPIN);
         ...
         parent->MapDialogRect(&r7);
         mfc7->Create(_T("Rows"),0,r7,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // EDITTEXT IDC_ROWS,43,43,38,12,0|ES_WANTRETURN
         CEdit* mfc8 = new CEdit(parent);
         CRect r8(CPoint(43,43),CSize(38,12));
         parent->MapDialogRect(&r8);
         mfc8->Create(0|ES_WANTRETURN,r8,parent,IDC_ROWS);
         mfcToQtWidget->insert(IDC_ROWS,mfc8);
       

          // CONTROL "", IDC_ROWS_SPIN, "msctls_updown32", BS_AUTORADIOBUTTON, 81, 43, 11, 13
          CSpinButtonCtrl* mfc9 = new CSpinButtonCtrl(parent);
          CRect r9(CPoint(81, 43), CSize(11, 13));
          parent->MapDialogRect(&r9);
          mfc9->Create(0|UDS_ARROWKEYS, r9, parent, IDC_ROWS_SPIN);
         ...
         parent->MapDialogRect(&r10);
         mfc10->Create(_T("Frames"),0,r10,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // EDITTEXT IDC_FRAMES,43,57,38,12,0|ES_READONLY
         CEdit* mfc11 = new CEdit(parent);
         CRect r11(CPoint(43,57),CSize(38,12));
         parent->MapDialogRect(&r11);
         mfc11->Create(0|ES_READONLY,r11,parent,IDC_FRAMES);
         mfcToQtWidget->insert(IDC_FRAMES,mfc11);
       

          // CONTROL "", IDC_FRAME_SPIN, "msctls_updown32", BS_AUTORADIOBUTTON, 81, 58, 11, 13
          CSpinButtonCtrl* mfc12 = new CSpinButtonCtrl(parent);
          CRect r12(CPoint(81, 58), CSize(11, 13));
          parent->MapDialogRect(&r12);
          mfc12->Create(0|UDS_ARROWKEYS, r12, parent, IDC_FRAME_SPIN);
         ...
         parent->MapDialogRect(&r13);
         mfc13->Create(_T("Edit settings"),0|0,r13,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r14);
         mfc14->Create(_T("Step"),0|0,r14,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // EDITTEXT IDC_KEYSTEP,43,90,38,12,0|ES_READONLY
         CEdit* mfc15 = new CEdit(parent);
         CRect r15(CPoint(43,90),CSize(38,12));
         parent->MapDialogRect(&r15);
         mfc15->Create(0|ES_READONLY,r15,parent,IDC_KEYSTEP);
         mfcToQtWidget->insert(IDC_KEYSTEP,mfc15);
       

          // CONTROL "", IDC_KEYSTEP_SPIN, "msctls_updown32", BS_AUTORADIOBUTTON, 81, 88, 11, 13
          CSpinButtonCtrl* mfc16 = new CSpinButtonCtrl(parent);
          CRect r16(CPoint(81, 88), CSize(11, 13));
          parent->MapDialogRect(&r16);
          mfc16->Create(0|UDS_ARROWKEYS, r16, parent, IDC_KEYSTEP_SPIN);
          mfcToQtWidget->insert(IDC_KEYSTEP_SPIN, mfc16);
      

          // CONTROL "Key repetition", IDC_KEYREPEAT, "Button", BS_AUTORADIOBUTTON, 13, 105, 68, 9
          CButton* mfc17 = new CButton(parent);
          CRect r17(CPoint(13, 105), CSize(68, 9));
          parent->MapDialogRect(&r17);
          mfc17->Create(_T("Key repetition"), 0|WS_TABSTOP, r17, parent, IDC_KEYREPEAT);
         ...
         parent->MapDialogRect(&r18);
         mfc18->Create(_T("Song information"),0,r18,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // EDITTEXT IDC_SONG_NAME,97,18,83,12,0|ES_AUTOHSCROLL
         CEdit* mfc19 = new CEdit(parent);
         CRect r19(CPoint(97,18),CSize(83,12));
         parent->MapDialogRect(&r19);
         mfc19->Create(0|ES_AUTOHSCROLL,r19,parent,IDC_SONG_NAME);
         mfcToQtWidget->insert(IDC_SONG_NAME,mfc19);
       

         // EDITTEXT IDC_SONG_ARTIST,97,33,83,12,0|ES_AUTOHSCROLL
         CEdit* mfc20 = new CEdit(parent);
         CRect r20(CPoint(97,33),CSize(83,12));
         parent->MapDialogRect(&r20);
         mfc20->Create(0|ES_AUTOHSCROLL,r20,parent,IDC_SONG_ARTIST);
         mfcToQtWidget->insert(IDC_SONG_ARTIST,mfc20);
       

         // EDITTEXT IDC_SONG_COPYRIGHT,97,49,83,12,0|ES_AUTOHSCROLL
         CEdit* mfc21 = new CEdit(parent);
         CRect r21(CPoint(97,49),CSize(83,12));
         parent->MapDialogRect(&r21);
         mfc21->Create(0|ES_AUTOHSCROLL,r21,parent,IDC_SONG_COPYRIGHT);
         ...
         parent->MapDialogRect(&r22);
         mfc22->Create(_T("Songs"),0,r22,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // COMBOBOX IDC_SUBTUNE,97,104,84,85,0|WS_TABSTOP
         CComboBox* mfc23 = new CComboBox(parent);
         CRect r23(CPoint(97,104),CSize(84,85));
         parent->MapDialogRect(&r23);
         mfc23->Create(0|WS_TABSTOP,r23,parent,IDC_SUBTUNE);
         mfcToQtWidget->insert(IDC_SUBTUNE,mfc23);
       

          // CONTROL "", IDC_INSTRUMENTS, "SysListView32", BS_AUTORADIOBUTTON, 193, 5, 202, 103
          CListCtrl* mfc24 = new CListCtrl(parent);
          CRect r24(CPoint(193, 5), CSize(202, 103));
          parent->MapDialogRect(&r24);
          mfc24->Create(0|WS_TABSTOP, r24, parent, IDC_INSTRUMENTS);
          mfcToQtWidget->insert(IDC_INSTRUMENTS, mfc24);
      

         // EDITTEXT IDC_INSTNAME,324,109,71,12,0|ES_AUTOHSCROLL
         CEdit* mfc25 = new CEdit(parent);
         CRect r25(CPoint(324,109),CSize(71,12));
         parent->MapDialogRect(&r25);
         mfc25->Create(0|ES_AUTOHSCROLL,r25,parent,IDC_INSTNAME);
   ...
   void qtMfcInitDialogResource_IDD_PCMIMPORT(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("Quality: 0"),0,r0,parent,IDC_QUALITY_FRM);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r1);
         mfc1->Create(_T("Low"),0,r1,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_QUALITY, "msctls_trackbar32", BS_AUTORADIOBUTTON, 30, 19, 90, 15
          CSliderCtrl* mfc2 = new CSliderCtrl(parent);
          CRect r2(CPoint(30, 19), CSize(90, 15));
          parent->MapDialogRect(&r2);
          mfc2->Create(0|WS_TABSTOP, r2, parent, IDC_QUALITY);
         ...
         parent->MapDialogRect(&r3);
         mfc3->Create(_T("High"),0,r3,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r4);
         mfc4->Create(_T("Gain: +0dB"),0,r4,parent,IDC_VOLUME_FRM);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r5);
         mfc5->Create(_T("Low"),0,r5,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_VOLUME, "msctls_trackbar32", BS_AUTORADIOBUTTON, 30, 59, 90, 15
          CSliderCtrl* mfc6 = new CSliderCtrl(parent);
          CRect r6(CPoint(30, 59), CSize(90, 15));
          parent->MapDialogRect(&r6);
          mfc6->Create(0|WS_TABSTOP, r6, parent, IDC_VOLUME);
         ...
         parent->MapDialogRect(&r7);
         mfc7->Create(_T("High"),0,r7,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r8);
         mfc8->Create(_T("File info"),0,r8,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r9);
         mfc9->Create(_T("Static"),0,r9,parent,IDC_SAMPLE_RATE);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r10);
         mfc10->Create(_T("Static"),0,r10,parent,IDC_RESAMPLING);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // PUSHBUTTON "Preview",IDC_PREVIEW,154,7,50,14,0
         CButton* mfc11 = new CButton(parent);
         CRect r11(CPoint(154,7),CSize(50,14));
         parent->MapDialogRect(&r11);
         mfc11->Create(_T("Preview"),0,r11,parent,IDC_PREVIEW);
         mfcToQtWidget->insert(IDC_PREVIEW,mfc11);
       

         // DEFPUSHBUTTON "OK",0,154,24,50,14
         CButton* mfc12 = new CButton(parent);
         CRect r12(CPoint(154,24),CSize(50,14));
         parent->MapDialogRect(&r12);
         mfc12->Create(_T("OK"),0,r12,parent,IDOK);
         mfcToQtWidget->insert(IDOK,mfc12);
       

         // PUSHBUTTON "Cancel",IDCANCEL,154,41,50,14,0
         CButton* mfc13 = new CButton(parent);
         CRect r13(CPoint(154,41),CSize(50,14));
         parent->MapDialogRect(&r13);
         mfc13->Create(_T("Cancel"),0,r13,parent,IDCANCEL);
         ...
         parent->MapDialogRect(&r14);
         mfc14->Create(_T("Static"),0,r14,parent,IDC_SAMPLESIZE);
         // IDC_STATIC do not get added to MFC-to-Qt map.
   ...
   void qtMfcInitDialogResource_IDD_INSTRUMENT_INTERNAL(CDialog* parent)
   {
      ...
      // BEGIN
          ...
          // CONTROL "", IDC_INSTSETTINGS, "SysListView32", BS_AUTORADIOBUTTON, 12, 18, 96, 109
          CListCtrl* mfc0 = new CListCtrl(parent);
          CRect r0(CPoint(12, 18), CSize(96, 109));
          parent->MapDialogRect(&r0);
          mfc0->Create(0|WS_TABSTOP, r0, parent, IDC_INSTSETTINGS);
          mfcToQtWidget->insert(IDC_INSTSETTINGS, mfc0);
      

         // PUSHBUTTON "Select next empty slot",IDC_FREE_SEQ,12,129,96,15,0
         CButton* mfc1 = new CButton(parent);
         CRect r1(CPoint(12,129),CSize(96,15));
         parent->MapDialogRect(&r1);
         mfc1->Create(_T("Select next empty slot"),0,r1,parent,IDC_FREE_SEQ);
         mfcToQtWidget->insert(IDC_FREE_SEQ,mfc1);
       

          // CONTROL "Sequence #", IDC_STATIC, "Static", BS_AUTORADIOBUTTON, 12, 149, 53, 10
          CStatic* mfc2 = new CStatic(parent);
          CRect r2(CPoint(12, 149), CSize(53, 10));
          parent->MapDialogRect(&r2);
          mfc2->Create(_T("Sequence #"), 0|WS_GROUP, r2, parent, IDC_STATIC);
          mfcToQtWidget->insert(IDC_STATIC, mfc2);
      

         // EDITTEXT IDC_SEQ_INDEX,69,147,39,12,0|ES_NUMBER
         CEdit* mfc3 = new CEdit(parent);
         CRect r3(CPoint(69,147),CSize(39,12));
         parent->MapDialogRect(&r3);
         mfc3->Create(0|ES_NUMBER,r3,parent,IDC_SEQ_INDEX);
         mfcToQtWidget->insert(IDC_SEQ_INDEX,mfc3);
       

          // CONTROL "", IDC_SEQUENCE_SPIN, "msctls_updown32", BS_AUTORADIOBUTTON, 66, 153, 11, 9
          CSpinButtonCtrl* mfc4 = new CSpinButtonCtrl(parent);
          CRect r4(CPoint(66, 153), CSize(11, 9));
          parent->MapDialogRect(&r4);
          mfc4->Create(0|UDS_ARROWKEYS, r4, parent, IDC_SEQUENCE_SPIN);
          mfcToQtWidget->insert(IDC_SEQUENCE_SPIN, mfc4);
      

         // EDITTEXT IDC_SEQUENCE_STRING,126,149,232,13,0|ES_AUTOHSCROLL
         CEdit* mfc5 = new CEdit(parent);
         CRect r5(CPoint(126,149),CSize(232,13));
         parent->MapDialogRect(&r5);
         mfc5->Create(0|ES_AUTOHSCROLL,r5,parent,IDC_SEQUENCE_STRING);
         ...
         parent->MapDialogRect(&r6);
         mfc6->Create(_T("Sequence editor"),0,r6,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r7);
         mfc7->Create(_T("Instrument settings"),0|0,r7,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
   ...
   void qtMfcInitDialogResource_IDD_INSTRUMENT_DPCM(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("Assigned samples"),0,r0,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

          // CONTROL "", IDC_TABLE, "SysListView32", BS_AUTORADIOBUTTON, 15, 19, 117, 125
          CListCtrl* mfc1 = new CListCtrl(parent);
          CRect r1(CPoint(15, 19), CSize(117, 125));
          parent->MapDialogRect(&r1);
          mfc1->Create(0|WS_TABSTOP, r1, parent, IDC_TABLE);
          mfcToQtWidget->insert(IDC_TABLE, mfc1);
      

         // COMBOBOX IDC_SAMPLES,15,148,117,125,0|WS_TABSTOP
         CComboBox* mfc2 = new CComboBox(parent);
         CRect r2(CPoint(15,148),CSize(117,125));
         parent->MapDialogRect(&r2);
         mfc2->Create(0|WS_TABSTOP,r2,parent,IDC_SAMPLES);
         ...
         parent->MapDialogRect(&r3);
         mfc3->Create(_T("Octave"),0,r3,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // COMBOBOX IDC_OCTAVE,138,29,42,53,0|WS_TABSTOP
         CComboBox* mfc4 = new CComboBox(parent);
         CRect r4(CPoint(138,29),CSize(42,53));
         parent->MapDialogRect(&r4);
         mfc4->Create(0|WS_TABSTOP,r4,parent,IDC_OCTAVE);
         ...
         parent->MapDialogRect(&r5);
         mfc5->Create(_T("Pitch"),0,r5,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // COMBOBOX IDC_PITCH,138,54,42,53,0|WS_TABSTOP
         CComboBox* mfc6 = new CComboBox(parent);
         CRect r6(CPoint(138,54),CSize(42,53));
         parent->MapDialogRect(&r6);
         mfc6->Create(0|WS_TABSTOP,r6,parent,IDC_PITCH);
         mfcToQtWidget->insert(IDC_PITCH,mfc6);
       

          // CONTROL "Loop", IDC_LOOP, "Button", BS_AUTORADIOBUTTON, 138, 71, 42, 9
          CButton* mfc7 = new CButton(parent);
          CRect r7(CPoint(138, 71), CSize(42, 9));
          parent->MapDialogRect(&r7);
          mfc7->Create(_T("Loop"), 0|WS_TABSTOP, r7, parent, IDC_LOOP);
          mfcToQtWidget->insert(IDC_LOOP, mfc7);
      

         // EDITTEXT IDC_DELTA_COUNTER,138,97,42,14,0|ES_AUTOHSCROLL
         CEdit* mfc8 = new CEdit(parent);
         CRect r8(CPoint(138,97),CSize(42,14));
         parent->MapDialogRect(&r8);
         mfc8->Create(0|ES_AUTOHSCROLL,r8,parent,IDC_DELTA_COUNTER);
         mfcToQtWidget->insert(IDC_DELTA_COUNTER,mfc8);
       

          // CONTROL "", IDC_DELTA_SPIN, "msctls_updown32", BS_AUTORADIOBUTTON, 170, 106, 11, 14
          CSpinButtonCtrl* mfc9 = new CSpinButtonCtrl(parent);
          CRect r9(CPoint(170, 106), CSize(11, 14));
          parent->MapDialogRect(&r9);
          mfc9->Create(0|UDS_ARROWKEYS, r9, parent, IDC_DELTA_SPIN);
          mfcToQtWidget->insert(IDC_DELTA_SPIN, mfc9);
      

         // PUSHBUTTON "",IDC_ADD,138,130,42,14,0|BS_ICON
         CButton* mfc10 = new CButton(parent);
         CRect r10(CPoint(138,130),CSize(42,14));
         parent->MapDialogRect(&r10);
         mfc10->Create(_T(""),0|BS_ICON,r10,parent,IDC_ADD);
         mfcToQtWidget->insert(IDC_ADD,mfc10);
       

         // PUSHBUTTON "",IDC_REMOVE,138,148,42,14,0|BS_ICON
         CButton* mfc11 = new CButton(parent);
         CRect r11(CPoint(138,148),CSize(42,14));
         parent->MapDialogRect(&r11);
         mfc11->Create(_T(""),0|BS_ICON,r11,parent,IDC_REMOVE);
         ...
         parent->MapDialogRect(&r12);
         mfc12->Create(_T("Loaded samples"),0,r12,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

          // CONTROL "", IDC_SAMPLE_LIST, "SysListView32", BS_AUTORADIOBUTTON, 198, 19, 108, 125
          CListCtrl* mfc13 = new CListCtrl(parent);
          CRect r13(CPoint(198, 19), CSize(108, 125));
          parent->MapDialogRect(&r13);
          mfc13->Create(0|WS_TABSTOP, r13, parent, IDC_SAMPLE_LIST);
         ...
         parent->MapDialogRect(&r14);
         mfc14->Create(_T("Space used 16 / 16 kb"),0,r14,parent,IDC_SPACE);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // DEFPUSHBUTTON "Load",0,312,19,47,14
         CButton* mfc15 = new CButton(parent);
         CRect r15(CPoint(312,19),CSize(47,14));
         parent->MapDialogRect(&r15);
         mfc15->Create(_T("Load"),0,r15,parent,IDC_LOAD);
         mfcToQtWidget->insert(IDC_LOAD,mfc15);
       

         // PUSHBUTTON "Unload",IDC_UNLOAD,312,35,47,14,0
         CButton* mfc16 = new CButton(parent);
         CRect r16(CPoint(312,35),CSize(47,14));
         parent->MapDialogRect(&r16);
         mfc16->Create(_T("Unload"),0,r16,parent,IDC_UNLOAD);
         mfcToQtWidget->insert(IDC_UNLOAD,mfc16);
       

         // PUSHBUTTON "Save",IDC_SAVE,312,51,47,14,0
         CButton* mfc17 = new CButton(parent);
         CRect r17(CPoint(312,51),CSize(47,14));
         parent->MapDialogRect(&r17);
         mfc17->Create(_T("Save"),0,r17,parent,IDC_SAVE);
         mfcToQtWidget->insert(IDC_SAVE,mfc17);
       

         // PUSHBUTTON "Import",IDC_IMPORT,312,67,47,14,0
         CButton* mfc18 = new CButton(parent);
         CRect r18(CPoint(312,67),CSize(47,14));
         parent->MapDialogRect(&r18);
         mfc18->Create(_T("Import"),0,r18,parent,IDC_IMPORT);
         mfcToQtWidget->insert(IDC_IMPORT,mfc18);
       

         // PUSHBUTTON "Edit",IDC_EDIT,312,83,47,14,0
         CButton* mfc19 = new CButton(parent);
         CRect r19(CPoint(312,83),CSize(47,14));
         parent->MapDialogRect(&r19);
         mfc19->Create(_T("Edit"),0,r19,parent,IDC_EDIT);
         mfcToQtWidget->insert(IDC_EDIT,mfc19);
       

         // PUSHBUTTON "Preview",IDC_PREVIEW,312,99,47,14,0
         CButton* mfc20 = new CButton(parent);
         CRect r20(CPoint(312,99),CSize(47,14));
         parent->MapDialogRect(&r20);
         mfc20->Create(_T("Preview"),0,r20,parent,IDC_PREVIEW);
         ...
         parent->MapDialogRect(&r21);
         mfc21->Create(_T("D-counter"),0,r21,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
   ...
   void qtMfcInitDialogResource_IDD_INSTRUMENT(CDialog* parent)
   {
      ...
      // BEGIN
          ...
          // CONTROL "", IDC_INST_TAB, "SysTabControl32", BS_AUTORADIOBUTTON, 7, 7, 375, 185
          CTabCtrl* mfc0 = new CTabCtrl(parent);
          CRect r0(CPoint(7, 7), CSize(375, 185));
          parent->MapDialogRect(&r0);
          mfc0->Create(0|0x0, r0, parent, IDC_INST_TAB);
          mfcToQtWidget->insert(IDC_INST_TAB, mfc0);
      

          // CONTROL "", IDC_KEYBOARD, "Static", BS_AUTORADIOBUTTON, 7, 198, 375, 37
          CStatic* mfc1 = new CStatic(parent);
          CRect r1(CPoint(7, 198), CSize(375, 37));
          parent->MapDialogRect(&r1);
          mfc1->Create(_T(""), 0|SS_SUNKEN, r1, parent, IDC_KEYBOARD);
   ...
   void qtMfcInitDialogResource_IDD_CONFIG_APPEARANCE(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("Color schemes"),0,r0,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // COMBOBOX IDC_SCHEME,15,22,135,126,0|WS_TABSTOP
         CComboBox* mfc1 = new CComboBox(parent);
         CRect r1(CPoint(15,22),CSize(135,126));
         parent->MapDialogRect(&r1);
         mfc1->Create(0|WS_TABSTOP,r1,parent,IDC_SCHEME);
         ...
         parent->MapDialogRect(&r2);
         mfc2->Create(_T("Colors"),0,r2,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r3);
         mfc3->Create(_T("Item"),0,r3,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // COMBOBOX IDC_COL_ITEM,35,66,115,172,0|WS_TABSTOP
         CComboBox* mfc4 = new CComboBox(parent);
         CRect r4(CPoint(35,66),CSize(115,172));
         parent->MapDialogRect(&r4);
         mfc4->Create(0|WS_TABSTOP,r4,parent,IDC_COL_ITEM);
         mfcToQtWidget->insert(IDC_COL_ITEM,mfc4);
       

          // CONTROL "", IDC_COL_PREVIEW, "Static", BS_AUTORADIOBUTTON, 15, 85, 69, 15
          CStatic* mfc5 = new CStatic(parent);
          CRect r5(CPoint(15, 85), CSize(69, 15));
          parent->MapDialogRect(&r5);
          mfc5->Create(_T(""), 0|SS_OWNERDRAW, r5, parent, IDC_COL_PREVIEW);
          mfcToQtWidget->insert(IDC_COL_PREVIEW, mfc5);
      

         // PUSHBUTTON "Pick color",IDC_PICK_COL,96,85,54,15,0
         CButton* mfc6 = new CButton(parent);
         CRect r6(CPoint(96,85),CSize(54,15));
         parent->MapDialogRect(&r6);
         mfc6->Create(_T("Pick color"),0,r6,parent,IDC_PICK_COL);
         mfcToQtWidget->insert(IDC_PICK_COL,mfc6);
       

          // CONTROL "Pattern colors", IDC_PATTERNCOLORS, "Button", BS_AUTORADIOBUTTON, 15, 105, 58, 9
          CButton* mfc7 = new CButton(parent);
          CRect r7(CPoint(15, 105), CSize(58, 9));
          parent->MapDialogRect(&r7);
          mfc7->Create(_T("Pattern colors"), 0|WS_TABSTOP, r7, parent, IDC_PATTERNCOLORS);
         ...
         parent->MapDialogRect(&r8);
         mfc8->Create(_T("Pattern font and size"),0,r8,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // COMBOBOX IDC_FONT,15,139,102,93,0|WS_TABSTOP
         CComboBox* mfc9 = new CComboBox(parent);
         CRect r9(CPoint(15,139),CSize(102,93));
         parent->MapDialogRect(&r9);
         mfc9->Create(0|WS_TABSTOP,r9,parent,IDC_FONT);
         mfcToQtWidget->insert(IDC_FONT,mfc9);
       

         // COMBOBOX IDC_FONT_SIZE,122,139,28,30,0|WS_TABSTOP
         CComboBox* mfc10 = new CComboBox(parent);
         CRect r10(CPoint(122,139),CSize(28,30));
         parent->MapDialogRect(&r10);
         mfc10->Create(0|WS_TABSTOP,r10,parent,IDC_FONT_SIZE);
         ...
         parent->MapDialogRect(&r11);
         mfc11->Create(_T("Preview"),0,r11,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

          // CONTROL "", IDC_PREVIEW, "Static", BS_AUTORADIOBUTTON, 176, 18, 90, 135
          CStatic* mfc12 = new CStatic(parent);
          CRect r12(CPoint(176, 18), CSize(90, 135));
          parent->MapDialogRect(&r12);
          mfc12->Create(_T(""), 0|SS_OWNERDRAW, r12, parent, IDC_PREVIEW);
          mfcToQtWidget->insert(IDC_PREVIEW, mfc12);
      

          // CONTROL "Display flats", IDC_DISPLAYFLATS, "Button", BS_AUTORADIOBUTTON, 83, 105, 58, 9
          CButton* mfc13 = new CButton(parent);
          CRect r13(CPoint(83, 105), CSize(58, 9));
          parent->MapDialogRect(&r13);
          mfc13->Create(_T("Display flats"), 0|WS_TABSTOP, r13, parent, IDC_DISPLAYFLATS);
   ...
   void qtMfcInitDialogResource_IDD_CONFIG_GENERAL(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("General settings"),0,r0,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

          // CONTROL "Wrap cursor", IDC_OPT_WRAPCURSOR, "Button", BS_AUTORADIOBUTTON, 13, 18, 113, 9
          CButton* mfc1 = new CButton(parent);
          CRect r1(CPoint(13, 18), CSize(113, 9));
          parent->MapDialogRect(&r1);
          mfc1->Create(_T("Wrap cursor"), 0|WS_TABSTOP, r1, parent, IDC_OPT_WRAPCURSOR);
          mfcToQtWidget->insert(IDC_OPT_WRAPCURSOR, mfc1);
      

          // CONTROL "Wrap across frames", IDC_OPT_WRAPFRAMES, "Button", BS_AUTORADIOBUTTON, 13, 28, 113, 9
          CButton* mfc2 = new CButton(parent);
          CRect r2(CPoint(13, 28), CSize(113, 9));
          parent->MapDialogRect(&r2);
          mfc2->Create(_T("Wrap across frames"), 0|WS_TABSTOP, r2, parent, IDC_OPT_WRAPFRAMES);
          mfcToQtWidget->insert(IDC_OPT_WRAPFRAMES, mfc2);
      

          // CONTROL "Free cursor edit", IDC_OPT_FREECURSOR, "Button", BS_AUTORADIOBUTTON, 13, 38, 113, 9
          CButton* mfc3 = new CButton(parent);
          CRect r3(CPoint(13, 38), CSize(113, 9));
          parent->MapDialogRect(&r3);
          mfc3->Create(_T("Free cursor edit"), 0|WS_TABSTOP, r3, parent, IDC_OPT_FREECURSOR);
          mfcToQtWidget->insert(IDC_OPT_FREECURSOR, mfc3);
      

          // CONTROL "Preview wave-files", IDC_OPT_WAVEPREVIEW, "Button", BS_AUTORADIOBUTTON, 13, 48, 113, 9
          CButton* mfc4 = new CButton(parent);
          CRect r4(CPoint(13, 48), CSize(113, 9));
          parent->MapDialogRect(&r4);
          mfc4->Create(_T("Preview wave-files"), 0|WS_TABSTOP, r4, parent, IDC_OPT_WAVEPREVIEW);
          mfcToQtWidget->insert(IDC_OPT_WAVEPREVIEW, mfc4);
      

          // CONTROL "Key repeat", IDC_OPT_KEYREPEAT, "Button", BS_AUTORADIOBUTTON, 13, 58, 113, 9
          CButton* mfc5 = new CButton(parent);
          CRect r5(CPoint(13, 58), CSize(113, 9));
          parent->MapDialogRect(&r5);
          mfc5->Create(_T("Key repeat"), 0|WS_TABSTOP, r5, parent, IDC_OPT_KEYREPEAT);
          mfcToQtWidget->insert(IDC_OPT_KEYREPEAT, mfc5);
      

          // CONTROL "Show row numbers in hex", IDC_OPT_HEXROW, "Button", BS_AUTORADIOBUTTON, 13, 68, 113, 9
          CButton* mfc6 = new CButton(parent);
          CRect r6(CPoint(13, 68), CSize(113, 9));
          parent->MapDialogRect(&r6);
          mfc6->Create(_T("Show row numbers in hex"), 0|WS_TABSTOP, r6, parent, IDC_OPT_HEXROW);
          mfcToQtWidget->insert(IDC_OPT_HEXROW, mfc6);
      

          // CONTROL "Preview next/previous frame", IDC_OPT_FRAMEPREVIEW, "Button", BS_AUTORADIOBUTTON, 13, 78, 113, 9
          CButton* mfc7 = new CButton(parent);
          CRect r7(CPoint(13, 78), CSize(113, 9));
          parent->MapDialogRect(&r7);
          mfc7->Create(_T("Preview next/previous frame"), 0|WS_TABSTOP, r7, parent, IDC_OPT_FRAMEPREVIEW);
          mfcToQtWidget->insert(IDC_OPT_FRAMEPREVIEW, mfc7);
      

          // CONTROL "Don't reset DPCM on note stop", IDC_OPT_NODPCMRESET, "Button", BS_AUTORADIOBUTTON, 13, 88, 113, 9
          CButton* mfc8 = new CButton(parent);
          CRect r8(CPoint(13, 88), CSize(113, 9));
          parent->MapDialogRect(&r8);
          mfc8->Create(_T("Don't reset DPCM on note stop"), 0|WS_TABSTOP, r8, parent, IDC_OPT_NODPCMRESET);
          mfcToQtWidget->insert(IDC_OPT_NODPCMRESET, mfc8);
      

          // CONTROL "Ignore Step when moving", IDC_OPT_NOSTEPMOVE, "Button", BS_AUTORADIOBUTTON, 13, 98, 113, 9
          CButton* mfc9 = new CButton(parent);
          CRect r9(CPoint(13, 98), CSize(113, 9));
          parent->MapDialogRect(&r9);
          mfc9->Create(_T("Ignore Step when moving"), 0|WS_TABSTOP, r9, parent, IDC_OPT_NOSTEPMOVE);
          mfcToQtWidget->insert(IDC_OPT_NOSTEPMOVE, mfc9);
      

          // CONTROL "Delete-key pulls up rows", IDC_OPT_PULLUPDELETE, "Button", BS_AUTORADIOBUTTON, 13, 108, 113, 9
          CButton* mfc10 = new CButton(parent);
          CRect r10(CPoint(13, 108), CSize(113, 9));
          parent->MapDialogRect(&r10);
          mfc10->Create(_T("Delete-key pulls up rows"), 0|WS_TABSTOP, r10, parent, IDC_OPT_PULLUPDELETE);
          mfcToQtWidget->insert(IDC_OPT_PULLUPDELETE, mfc10);
      

          // CONTROL "Backup files", IDC_OPT_BACKUPS, "Button", BS_AUTORADIOBUTTON, 13, 118, 113, 9
          CButton* mfc11 = new CButton(parent);
          CRect r11(CPoint(13, 118), CSize(113, 9));
          parent->MapDialogRect(&r11);
          mfc11->Create(_T("Backup files"), 0|WS_TABSTOP, r11, parent, IDC_OPT_BACKUPS);
          mfcToQtWidget->insert(IDC_OPT_BACKUPS, mfc11);
      

          // CONTROL "Single instance", IDC_OPT_SINGLEINSTANCE, "Button", BS_AUTORADIOBUTTON, 13, 128, 113, 9
          CButton* mfc12 = new CButton(parent);
          CRect r12(CPoint(13, 128), CSize(113, 9));
          parent->MapDialogRect(&r12);
          mfc12->Create(_T("Single instance"), 0|WS_TABSTOP, r12, parent, IDC_OPT_SINGLEINSTANCE);
         ...
         parent->MapDialogRect(&r13);
         mfc13->Create(_T("Pattern edit style"),0,r13,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
          ...
          parent->MapDialogRect(&r14);
          mfc14->Create(_T("FastTracker 2"), 0|BS_AUTORADIOBUTTON, r14, parent, IDC_STYLE1);
          ...
          parent->MapDialogRect(&r15);
          mfc15->Create(_T("ModPlug tracker"), 0|BS_AUTORADIOBUTTON, r15, parent, IDC_STYLE2);
          ...
          parent->MapDialogRect(&r16);
          mfc16->Create(_T("Impulse Tracker"), 0|BS_AUTORADIOBUTTON, r16, parent, IDC_STYLE3);
         ...
         parent->MapDialogRect(&r17);
         mfc17->Create(_T("Edit settings"),0,r17,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r18);
         mfc18->Create(_T("Page jump length"),0,r18,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // COMBOBOX IDC_PAGELENGTH,215,68,48,65,0|WS_TABSTOP
         CComboBox* mfc19 = new CComboBox(parent);
         CRect r19(CPoint(215,68),CSize(48,65));
         parent->MapDialogRect(&r19);
         mfc19->Create(0|WS_TABSTOP,r19,parent,IDC_PAGELENGTH);
         ...
         parent->MapDialogRect(&r20);
         mfc20->Create(_T("Keys"),0,r20,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r21);
         mfc21->Create(_T("Note cut"),0,r21,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // EDITTEXT IDC_KEY_NOTE_CUT,204,99,60,13,0|ES_READONLY
         CEdit* mfc22 = new CEdit(parent);
         CRect r22(CPoint(204,99),CSize(60,13));
         parent->MapDialogRect(&r22);
         mfc22->Create(0|ES_READONLY,r22,parent,IDC_KEY_NOTE_CUT);
         ...
         parent->MapDialogRect(&r23);
         mfc23->Create(_T("Clear field"),0,r23,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // EDITTEXT IDC_KEY_CLEAR,204,114,60,13,0|ES_READONLY
         CEdit* mfc24 = new CEdit(parent);
         CRect r24(CPoint(204,114),CSize(60,13));
         parent->MapDialogRect(&r24);
         mfc24->Create(0|ES_READONLY,r24,parent,IDC_KEY_CLEAR);
         ...
         parent->MapDialogRect(&r25);
         mfc25->Create(_T("Repeat"),0,r25,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // EDITTEXT IDC_KEY_REPEAT,204,128,60,13,0|ES_READONLY
         CEdit* mfc26 = new CEdit(parent);
         CRect r26(CPoint(204,128),CSize(60,13));
         parent->MapDialogRect(&r26);
         mfc26->Create(0|ES_READONLY,r26,parent,IDC_KEY_REPEAT);
         ...
         mfc27->Create(_T("Note release"),0,r27,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // EDITTEXT IDC_KEY_NOTE_RELEASE,204,142,60,13,0|ES_READONLY
         CEdit* mfc28 = new CEdit(parent);
         CRect r28(CPoint(204,142),CSize(60,13));
         parent->MapDialogRect(&r28);
         mfc28->Create(0|ES_READONLY,r28,parent,IDC_KEY_NOTE_RELEASE);
         mfcToQtWidget->insert(IDC_KEY_NOTE_RELEASE,mfc28);
       

          // CONTROL "Preview full row", IDC_OPT_PREVIEWFULLROW, "Button", BS_AUTORADIOBUTTON, 13, 138, 113, 9
          CButton* mfc29 = new CButton(parent);
          CRect r29(CPoint(13, 138), CSize(113, 9));
          parent->MapDialogRect(&r29);
          mfc29->Create(_T("Preview full row"), 0|WS_TABSTOP, r29, parent, IDC_OPT_PREVIEWFULLROW);
          mfcToQtWidget->insert(IDC_OPT_PREVIEWFULLROW, mfc29);
      

          // CONTROL "Don't select on double-click", IDC_OPT_DOUBLECLICK, "Button", BS_AUTORADIOBUTTON, 13, 148, 113, 9
          CButton* mfc30 = new CButton(parent);
          CRect r30(CPoint(13, 148), CSize(113, 9));
          parent->MapDialogRect(&r30);
          mfc30->Create(_T("Don't select on double-click"), 0|WS_TABSTOP, r30, parent, IDC_OPT_DOUBLECLICK);
   ...
   void qtMfcInitDialogResource_IDD_CONFIG_MIDI(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("Input Device"),0,r0,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // COMBOBOX IDC_INDEVICES,13,20,253,50,0|WS_TABSTOP
         CComboBox* mfc1 = new CComboBox(parent);
         CRect r1(CPoint(13,20),CSize(253,50));
         parent->MapDialogRect(&r1);
         mfc1->Create(0|WS_TABSTOP,r1,parent,IDC_INDEVICES);
         ...
         parent->MapDialogRect(&r2);
         mfc2->Create(_T("Output Device"),0,r2,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // COMBOBOX IDC_OUTDEVICES,13,61,253,50,0|WS_TABSTOP
         CComboBox* mfc3 = new CComboBox(parent);
         CRect r3(CPoint(13,61),CSize(253,50));
         parent->MapDialogRect(&r3);
         mfc3->Create(0|WS_TABSTOP,r3,parent,IDC_OUTDEVICES);
         mfcToQtWidget->insert(IDC_OUTDEVICES,mfc3);
       

          // CONTROL "Receive sync ticks", IDC_MASTER_SYNC, "Button", BS_AUTORADIOBUTTON, 13, 102, 173, 10
          CButton* mfc4 = new CButton(parent);
          CRect r4(CPoint(13, 102), CSize(173, 10));
          parent->MapDialogRect(&r4);
          mfc4->Create(_T("Receive sync ticks"), 0|WS_TABSTOP, r4, parent, IDC_MASTER_SYNC);
          mfcToQtWidget->insert(IDC_MASTER_SYNC, mfc4);
      

          // CONTROL "Skip key releases", IDC_KEY_RELEASE, "Button", BS_AUTORADIOBUTTON, 13, 112, 173, 10
          CButton* mfc5 = new CButton(parent);
          CRect r5(CPoint(13, 112), CSize(173, 10));
          parent->MapDialogRect(&r5);
          mfc5->Create(_T("Skip key releases"), 0|WS_TABSTOP, r5, parent, IDC_KEY_RELEASE);
          mfcToQtWidget->insert(IDC_KEY_RELEASE, mfc5);
      

          // CONTROL "Map MIDI channels to NES channels", IDC_CHANMAP, "Button", BS_AUTORADIOBUTTON, 13, 122, 173, 10
          CButton* mfc6 = new CButton(parent);
          CRect r6(CPoint(13, 122), CSize(173, 10));
          parent->MapDialogRect(&r6);
          mfc6->Create(_T("Map MIDI channels to NES channels"), 0|WS_TABSTOP, r6, parent, IDC_CHANMAP);
          mfcToQtWidget->insert(IDC_CHANMAP, mfc6);
      

          // CONTROL "Record velocities", IDC_VELOCITY, "Button", BS_AUTORADIOBUTTON, 13, 132, 173, 10
          CButton* mfc7 = new CButton(parent);
          CRect r7(CPoint(13, 132), CSize(173, 10));
          parent->MapDialogRect(&r7);
          mfc7->Create(_T("Record velocities"), 0|WS_TABSTOP, r7, parent, IDC_VELOCITY);
          mfcToQtWidget->insert(IDC_VELOCITY, mfc7);
      

          // CONTROL "Auto arpeggiate chords", IDC_ARPEGGIATE, "Button", BS_AUTORADIOBUTTON, 13, 142, 173, 10
          CButton* mfc8 = new CButton(parent);
          CRect r8(CPoint(13, 142), CSize(173, 10));
          parent->MapDialogRect(&r8);
          mfc8->Create(_T("Auto arpeggiate chords"), 0|WS_TABSTOP, r8, parent, IDC_ARPEGGIATE);
         ...
         parent->MapDialogRect(&r9);
         mfc9->Create(_T("Options"),0,r9,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
   ...
   void qtMfcInitDialogResource_IDD_CONFIG_SOUND(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         CRect r0(CPoint(7,7),CSize(266,35));
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("Device"),0,r0,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // COMBOBOX IDC_DEVICES,13,20,253,12,0|WS_TABSTOP
         CComboBox* mfc1 = new CComboBox(parent);
         CRect r1(CPoint(13,20),CSize(253,12));
         parent->MapDialogRect(&r1);
         mfc1->Create(0|WS_TABSTOP,r1,parent,IDC_DEVICES);
         ...
         parent->MapDialogRect(&r2);
         mfc2->Create(_T("Sample rate"),0,r2,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // COMBOBOX IDC_SAMPLE_RATE,13,61,101,62,0|WS_TABSTOP
         CComboBox* mfc3 = new CComboBox(parent);
         CRect r3(CPoint(13,61),CSize(101,62));
         parent->MapDialogRect(&r3);
         mfc3->Create(0|WS_TABSTOP,r3,parent,IDC_SAMPLE_RATE);
         ...
         parent->MapDialogRect(&r4);
         mfc4->Create(_T("Sample size"),0,r4,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // COMBOBOX IDC_SAMPLE_SIZE,13,102,101,62,0|WS_TABSTOP
         CComboBox* mfc5 = new CComboBox(parent);
         CRect r5(CPoint(13,102),CSize(101,62));
         parent->MapDialogRect(&r5);
         mfc5->Create(0|WS_TABSTOP,r5,parent,IDC_SAMPLE_SIZE);
         ...
         parent->MapDialogRect(&r6);
         mfc6->Create(_T("Buffer length"),0,r6,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

          // CONTROL "", IDC_BUF_LENGTH, "msctls_trackbar32", BS_AUTORADIOBUTTON, 13, 141, 69, 12
          CSliderCtrl* mfc7 = new CSliderCtrl(parent);
          CRect r7(CPoint(13, 141), CSize(69, 12));
          parent->MapDialogRect(&r7);
          mfc7->Create(0|WS_TABSTOP, r7, parent, IDC_BUF_LENGTH);
         ...
         parent->MapDialogRect(&r8);
         mfc8->Create(_T("20 ms"),0,r8,parent,IDC_BUF_LEN);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r9);
         mfc9->Create(_T("Bass filtering"),0,r9,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r10);
         mfc10->Create(_T("Frequency"),0,r10,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_BASS_FREQ, "msctls_trackbar32", BS_AUTORADIOBUTTON, 174, 63, 55, 12
          CSliderCtrl* mfc11 = new CSliderCtrl(parent);
          CRect r11(CPoint(174, 63), CSize(55, 12));
          parent->MapDialogRect(&r11);
          mfc11->Create(0|WS_TABSTOP, r11, parent, IDC_BASS_FREQ);
         ...
         parent->MapDialogRect(&r12);
         mfc12->Create(_T("16 Hz"),0,r12,parent,IDC_BASS_FREQ_T);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r13);
         mfc13->Create(_T("Treble filtering"),0,r13,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r14);
         mfc14->Create(_T("Damping"),0,r14,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_TREBLE_DAMP, "msctls_trackbar32", BS_AUTORADIOBUTTON, 174, 99, 55, 12
          CSliderCtrl* mfc15 = new CSliderCtrl(parent);
          CRect r15(CPoint(174, 99), CSize(55, 12));
          parent->MapDialogRect(&r15);
          mfc15->Create(0|WS_TABSTOP, r15, parent, IDC_TREBLE_DAMP);
         ...
         parent->MapDialogRect(&r16);
         mfc16->Create(_T("-24 dB"),0,r16,parent,IDC_TREBLE_DAMP_T);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r17);
         mfc17->Create(_T("Frequency"),0,r17,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_TREBLE_FREQ, "msctls_trackbar32", BS_AUTORADIOBUTTON, 174, 112, 55, 12
          CSliderCtrl* mfc18 = new CSliderCtrl(parent);
          CRect r18(CPoint(174, 112), CSize(55, 12));
          parent->MapDialogRect(&r18);
          mfc18->Create(0|WS_TABSTOP, r18, parent, IDC_TREBLE_FREQ);
         ...
         parent->MapDialogRect(&r19);
         mfc19->Create(_T("12000 Hz"),0,r19,parent,IDC_TREBLE_FREQ_T);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r20);
         mfc20->Create(_T("Volume"),0,r20,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

          // CONTROL "", IDC_VOLUME, "msctls_trackbar32", BS_AUTORADIOBUTTON, 132, 144, 96, 12
          CSliderCtrl* mfc21 = new CSliderCtrl(parent);
          CRect r21(CPoint(132, 144), CSize(96, 12));
          parent->MapDialogRect(&r21);
          mfc21->Create(0|WS_TABSTOP, r21, parent, IDC_VOLUME);
         ...
         parent->MapDialogRect(&r22);
         mfc22->Create(_T("100 %"),0,r22,parent,IDC_VOLUME_T);
         // IDC_STATIC do not get added to MFC-to-Qt map.
   ...
   void qtMfcInitDialogResource_IDD_CONFIG_SHORTCUTS(CDialog* parent)
   {
      ...
      // BEGIN
          ...
          // CONTROL "", IDC_SHORTCUTS, "SysListView32", BS_AUTORADIOBUTTON, 7, 7, 266, 136
          CListCtrl* mfc0 = new CListCtrl(parent);
          CRect r0(CPoint(7, 7), CSize(266, 136));
          parent->MapDialogRect(&r0);
          mfc0->Create(0|WS_TABSTOP, r0, parent, IDC_SHORTCUTS);
         ...
         parent->MapDialogRect(&r1);
         mfc1->Create(_T("Keys:"),0,r1,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // EDITTEXT IDC_KEY,36,147,144,14,0|ES_READONLY
         CEdit* mfc2 = new CEdit(parent);
         CRect r2(CPoint(36,147),CSize(144,14));
         parent->MapDialogRect(&r2);
         mfc2->Create(0|ES_READONLY,r2,parent,IDC_KEY);
         mfcToQtWidget->insert(IDC_KEY,mfc2);
       

         // PUSHBUTTON "Clear",IDC_CLEAR,186,147,36,14,0
         CButton* mfc3 = new CButton(parent);
         CRect r3(CPoint(186,147),CSize(36,14));
         parent->MapDialogRect(&r3);
         mfc3->Create(_T("Clear"),0,r3,parent,IDC_CLEAR);
         mfcToQtWidget->insert(IDC_CLEAR,mfc3);
       

         // PUSHBUTTON "Default",IDC_DEFAULT,228,147,45,14,0
         CButton* mfc4 = new CButton(parent);
         CRect r4(CPoint(228,147),CSize(45,14));
         parent->MapDialogRect(&r4);
         mfc4->Create(_T("Default"),0,r4,parent,IDC_DEFAULT);
   ...
   void qtMfcInitDialogResource_IDD_OCTAVE(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         // COMBOBOX IDC_OCTAVE,36,0,30,74,0|WS_TABSTOP
         CComboBox* mfc0 = new CComboBox(parent);
         CRect r0(CPoint(36,0),CSize(30,74));
         parent->MapDialogRect(&r0);
         mfc0->Create(0|WS_TABSTOP,r0,parent,IDC_OCTAVE);
         mfcToQtWidget->insert(IDC_OCTAVE,mfc0);
       

          // CONTROL "Octave", IDC_STATIC, "Static", BS_AUTORADIOBUTTON, 6, 1, 24, 8
          CStatic* mfc1 = new CStatic(parent);
          CRect r1(CPoint(6, 1), CSize(24, 8));
          parent->MapDialogRect(&r1);
          mfc1->Create(_T("Octave"), 0|WS_GROUP, r1, parent, IDC_STATIC);
          mfcToQtWidget->insert(IDC_STATIC, mfc1);
      

          // CONTROL "Follow-mode", IDC_FOLLOW, "Button", BS_AUTORADIOBUTTON, 72, 0, 52, 13
          CButton* mfc2 = new CButton(parent);
          CRect r2(CPoint(72, 0), CSize(52, 13));
          parent->MapDialogRect(&r2);
          mfc2->Create(_T("Follow-mode"), 0|WS_TABSTOP, r2, parent, IDC_FOLLOW);
          mfcToQtWidget->insert(IDC_FOLLOW, mfc2);
      

          // CONTROL "Row highlight, 1st", IDC_STATIC, "Static", BS_AUTORADIOBUTTON, 129, 1, 58, 8
          CStatic* mfc3 = new CStatic(parent);
          CRect r3(CPoint(129, 1), CSize(58, 8));
          parent->MapDialogRect(&r3);
          mfc3->Create(_T("Row highlight, 1st"), 0|WS_GROUP, r3, parent, IDC_STATIC);
          mfcToQtWidget->insert(IDC_STATIC, mfc3);
      

         // EDITTEXT IDC_HIGHLIGHT1,191,0,27,12,0|ES_NUMBER
         CEdit* mfc4 = new CEdit(parent);
         CRect r4(CPoint(191,0),CSize(27,12));
         parent->MapDialogRect(&r4);
         mfc4->Create(0|ES_NUMBER,r4,parent,IDC_HIGHLIGHT1);
         mfcToQtWidget->insert(IDC_HIGHLIGHT1,mfc4);
       

          // CONTROL "", IDC_HIGHLIGHTSPIN1, "msctls_updown32", BS_AUTORADIOBUTTON, 213, 2, 11, 6
          CSpinButtonCtrl* mfc5 = new CSpinButtonCtrl(parent);
          CRect r5(CPoint(213, 2), CSize(11, 6));
          parent->MapDialogRect(&r5);
          mfc5->Create(0|UDS_HOTTRACK, r5, parent, IDC_HIGHLIGHTSPIN1);
          mfcToQtWidget->insert(IDC_HIGHLIGHTSPIN1, mfc5);
      

          // CONTROL "2nd", IDC_STATIC, "Static", BS_AUTORADIOBUTTON, 225, 1, 13, 8
          CStatic* mfc6 = new CStatic(parent);
          CRect r6(CPoint(225, 1), CSize(13, 8));
          parent->MapDialogRect(&r6);
          mfc6->Create(_T("2nd"), 0|WS_GROUP, r6, parent, IDC_STATIC);
          mfcToQtWidget->insert(IDC_STATIC, mfc6);
      

         // EDITTEXT IDC_HIGHLIGHT2,241,0,27,12,0|ES_NUMBER
         CEdit* mfc7 = new CEdit(parent);
         CRect r7(CPoint(241,0),CSize(27,12));
         parent->MapDialogRect(&r7);
         mfc7->Create(0|ES_NUMBER,r7,parent,IDC_HIGHLIGHT2);
         mfcToQtWidget->insert(IDC_HIGHLIGHT2,mfc7);
       

          // CONTROL "", IDC_HIGHLIGHTSPIN2, "msctls_updown32", BS_AUTORADIOBUTTON, 263, 2, 11, 6
          CSpinButtonCtrl* mfc8 = new CSpinButtonCtrl(parent);
          CRect r8(CPoint(263, 2), CSize(11, 6));
          parent->MapDialogRect(&r8);
          mfc8->Create(0|UDS_HOTTRACK, r8, parent, IDC_HIGHLIGHTSPIN2);
   ...
   void qtMfcInitDialogResource_IDD_EXPORT(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         // DEFPUSHBUTTON "&Export",0,187,7,53,14
         CButton* mfc0 = new CButton(parent);
         CRect r0(CPoint(187,7),CSize(53,14));
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("&Export"),0,r0,parent,IDC_EXPORT);
         mfcToQtWidget->insert(IDC_EXPORT,mfc0);
       

         // PUSHBUTTON "&Close",IDC_CLOSE,187,23,53,14,0
         CButton* mfc1 = new CButton(parent);
         CRect r1(CPoint(187,23),CSize(53,14));
         parent->MapDialogRect(&r1);
         mfc1->Create(_T("&Close"),0,r1,parent,IDC_CLOSE);
         mfcToQtWidget->insert(IDC_CLOSE,mfc1);
       

         // EDITTEXT IDC_NAME,60,18,114,13,0|ES_AUTOHSCROLL
         CEdit* mfc2 = new CEdit(parent);
         CRect r2(CPoint(60,18),CSize(114,13));
         parent->MapDialogRect(&r2);
         mfc2->Create(0|ES_AUTOHSCROLL,r2,parent,IDC_NAME);
         mfcToQtWidget->insert(IDC_NAME,mfc2);
       

         // EDITTEXT IDC_ARTIST,60,33,114,13,0|ES_AUTOHSCROLL
         CEdit* mfc3 = new CEdit(parent);
         CRect r3(CPoint(60,33),CSize(114,13));
         parent->MapDialogRect(&r3);
         mfc3->Create(0|ES_AUTOHSCROLL,r3,parent,IDC_ARTIST);
         mfcToQtWidget->insert(IDC_ARTIST,mfc3);
       

         // EDITTEXT IDC_COPYRIGHT,60,49,114,13,0|ES_AUTOHSCROLL
         CEdit* mfc4 = new CEdit(parent);
         CRect r4(CPoint(60,49),CSize(114,13));
         parent->MapDialogRect(&r4);
         mfc4->Create(0|ES_AUTOHSCROLL,r4,parent,IDC_COPYRIGHT);
         mfcToQtWidget->insert(IDC_COPYRIGHT,mfc4);
          ...
          parent->MapDialogRect(&r5);
          mfc5->Create(_T("NTSC"), 0|BS_AUTORADIOBUTTON, r5, parent, IDC_NTSC);
          ...
          parent->MapDialogRect(&r6);
          mfc6->Create(_T("PAL"), 0|BS_AUTORADIOBUTTON, r6, parent, IDC_PAL);
          ...
          parent->MapDialogRect(&r7);
          mfc7->Create(_T("Dual"), 0|BS_AUTORADIOBUTTON, r7, parent, IDC_DUAL);
          mfcToQtWidget->insert(IDC_DUAL, mfc7);
      

         // COMBOBOX IDC_TYPE,16,97,218,100,0|WS_TABSTOP
         CComboBox* mfc8 = new CComboBox(parent);
         CRect r8(CPoint(16,97),CSize(218,100));
         parent->MapDialogRect(&r8);
         mfc8->Create(0|WS_TABSTOP,r8,parent,IDC_TYPE);
         ...
         parent->MapDialogRect(&r9);
         mfc9->Create(_T("NSF file options"),0,r9,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r10);
         mfc10->Create(_T("Name"),0,r10,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r11);
         mfc11->Create(_T("Artist"),0,r11,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r12);
         mfc12->Create(_T("Copyright"),0,r12,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r13);
         mfc13->Create(_T("Progress"),0,r13,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // EDITTEXT IDC_OUTPUT,16,132,218,139,0|WS_VSCROLL
         CEdit* mfc14 = new CEdit(parent);
         CRect r14(CPoint(16,132),CSize(218,139));
         parent->MapDialogRect(&r14);
         mfc14->Create(0|WS_VSCROLL,r14,parent,IDC_OUTPUT);
         ...
         parent->MapDialogRect(&r15);
         mfc15->Create(_T("Type of file"),0,r15,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // PUSHBUTTON "&Play",IDC_PLAY,187,68,53,14,0
         CButton* mfc16 = new CButton(parent);
         CRect r16(CPoint(187,68),CSize(53,14));
         parent->MapDialogRect(&r16);
         mfc16->Create(_T("&Play"),0,r16,parent,IDC_PLAY);
   ...
   void qtMfcInitDialogResource_IDD_INSTRUMENT_VRC7(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("Patch"),0,r0,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // COMBOBOX IDC_PATCH,15,18,295,128,0|WS_TABSTOP
         CComboBox* mfc1 = new CComboBox(parent);
         CRect r1(CPoint(15,18),CSize(295,128));
         parent->MapDialogRect(&r1);
         mfc1->Create(0|WS_TABSTOP,r1,parent,IDC_PATCH);
         mfcToQtWidget->insert(IDC_PATCH,mfc1);
       

         // PUSHBUTTON "Copy",IDC_COPY,322,7,43,14,0
         CButton* mfc2 = new CButton(parent);
         CRect r2(CPoint(322,7),CSize(43,14));
         parent->MapDialogRect(&r2);
         mfc2->Create(_T("Copy"),0,r2,parent,IDC_COPY);
         mfcToQtWidget->insert(IDC_COPY,mfc2);
       

         // PUSHBUTTON "Paste",IDC_PASTE,322,23,43,14,0
         CButton* mfc3 = new CButton(parent);
         CRect r3(CPoint(322,23),CSize(43,14));
         parent->MapDialogRect(&r3);
         mfc3->Create(_T("Paste"),0,r3,parent,IDC_PASTE);
         ...
         parent->MapDialogRect(&r4);
         mfc4->Create(_T("Modulator settings"),0,r4,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

          // CONTROL "Amplitude modulation", IDC_M_AM, "Button", BS_AUTORADIOBUTTON, 14, 54, 84, 10
          CButton* mfc5 = new CButton(parent);
          CRect r5(CPoint(14, 54), CSize(84, 10));
          parent->MapDialogRect(&r5);
          mfc5->Create(_T("Amplitude modulation"), 0|WS_TABSTOP, r5, parent, IDC_M_AM);
          mfcToQtWidget->insert(IDC_M_AM, mfc5);
      

          // CONTROL "Vibrato", IDC_M_VIB, "Button", BS_AUTORADIOBUTTON, 109, 54, 39, 10
          CButton* mfc6 = new CButton(parent);
          CRect r6(CPoint(109, 54), CSize(39, 10));
          parent->MapDialogRect(&r6);
          mfc6->Create(_T("Vibrato"), 0|WS_TABSTOP, r6, parent, IDC_M_VIB);
          mfcToQtWidget->insert(IDC_M_VIB, mfc6);
      

          // CONTROL "Sustained", IDC_M_EG, "Button", BS_AUTORADIOBUTTON, 14, 70, 47, 10
          CButton* mfc7 = new CButton(parent);
          CRect r7(CPoint(14, 70), CSize(47, 10));
          parent->MapDialogRect(&r7);
          mfc7->Create(_T("Sustained"), 0|WS_TABSTOP, r7, parent, IDC_M_EG);
          mfcToQtWidget->insert(IDC_M_EG, mfc7);
      

          // CONTROL "Key scaling", IDC_M_KSR2, "Button", BS_AUTORADIOBUTTON, 14, 86, 51, 10
          CButton* mfc8 = new CButton(parent);
          CRect r8(CPoint(14, 86), CSize(51, 10));
          parent->MapDialogRect(&r8);
          mfc8->Create(_T("Key scaling"), 0|WS_TABSTOP, r8, parent, IDC_M_KSR2);
          mfcToQtWidget->insert(IDC_M_KSR2, mfc8);
      

          // CONTROL "Wave rectification", IDC_M_DM, "Button", BS_AUTORADIOBUTTON, 74, 70, 74, 10
          CButton* mfc9 = new CButton(parent);
          CRect r9(CPoint(74, 70), CSize(74, 10));
          parent->MapDialogRect(&r9);
          mfc9->Create(_T("Wave rectification"), 0|WS_TABSTOP, r9, parent, IDC_M_DM);
         ...
         parent->MapDialogRect(&r10);
         mfc10->Create(_T("Level"),0,r10,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_M_KSL, "msctls_trackbar32", BS_AUTORADIOBUTTON, 90, 86, 58, 11
          CSliderCtrl* mfc11 = new CSliderCtrl(parent);
          CRect r11(CPoint(90, 86), CSize(58, 11));
          parent->MapDialogRect(&r11);
          mfc11->Create(0|WS_TABSTOP, r11, parent, IDC_M_KSL);
         ...
         parent->MapDialogRect(&r12);
         mfc12->Create(_T("Mult. factor"),0,r12,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_M_MUL, "msctls_trackbar32", BS_AUTORADIOBUTTON, 51, 107, 105, 11
          CSliderCtrl* mfc13 = new CSliderCtrl(parent);
          CRect r13(CPoint(51, 107), CSize(105, 11));
          parent->MapDialogRect(&r13);
          mfc13->Create(0|WS_TABSTOP, r13, parent, IDC_M_MUL);
         ...
         parent->MapDialogRect(&r14);
         mfc14->Create(_T("Attack"),0,r14,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_M_AR, "msctls_trackbar32", BS_AUTORADIOBUTTON, 40, 126, 42, 11
          CSliderCtrl* mfc15 = new CSliderCtrl(parent);
          CRect r15(CPoint(40, 126), CSize(42, 11));
          parent->MapDialogRect(&r15);
          mfc15->Create(0|WS_TABSTOP, r15, parent, IDC_M_AR);
         ...
         parent->MapDialogRect(&r16);
         mfc16->Create(_T("Decay"),0,r16,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_M_DR, "msctls_trackbar32", BS_AUTORADIOBUTTON, 114, 126, 42, 11
          CSliderCtrl* mfc17 = new CSliderCtrl(parent);
          CRect r17(CPoint(114, 126), CSize(42, 11));
          parent->MapDialogRect(&r17);
          mfc17->Create(0|WS_TABSTOP, r17, parent, IDC_M_DR);
         ...
         parent->MapDialogRect(&r18);
         mfc18->Create(_T("Sustain"),0,r18,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_M_SL, "msctls_trackbar32", BS_AUTORADIOBUTTON, 39, 143, 42, 11
          CSliderCtrl* mfc19 = new CSliderCtrl(parent);
          CRect r19(CPoint(39, 143), CSize(42, 11));
          parent->MapDialogRect(&r19);
          mfc19->Create(0|WS_TABSTOP, r19, parent, IDC_M_SL);
         ...
         parent->MapDialogRect(&r20);
         mfc20->Create(_T("Release"),0,r20,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_M_RR, "msctls_trackbar32", BS_AUTORADIOBUTTON, 114, 143, 42, 11
          CSliderCtrl* mfc21 = new CSliderCtrl(parent);
          CRect r21(CPoint(114, 143), CSize(42, 11));
          parent->MapDialogRect(&r21);
          mfc21->Create(0|WS_TABSTOP, r21, parent, IDC_M_RR);
         ...
         parent->MapDialogRect(&r22);
         mfc22->Create(_T("Carrier settings"),0,r22,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

          // CONTROL "Amplitude modulation", IDC_C_AM, "Button", BS_AUTORADIOBUTTON, 171, 54, 84, 10
          CButton* mfc23 = new CButton(parent);
          CRect r23(CPoint(171, 54), CSize(84, 10));
          parent->MapDialogRect(&r23);
          mfc23->Create(_T("Amplitude modulation"), 0|WS_TABSTOP, r23, parent, IDC_C_AM);
          mfcToQtWidget->insert(IDC_C_AM, mfc23);
      

          // CONTROL "Vibrato", IDC_C_VIB, "Button", BS_AUTORADIOBUTTON, 267, 54, 39, 10
          CButton* mfc24 = new CButton(parent);
          CRect r24(CPoint(267, 54), CSize(39, 10));
          parent->MapDialogRect(&r24);
          mfc24->Create(_T("Vibrato"), 0|WS_TABSTOP, r24, parent, IDC_C_VIB);
          mfcToQtWidget->insert(IDC_C_VIB, mfc24);
      

          // CONTROL "Sustained", IDC_C_EG, "Button", BS_AUTORADIOBUTTON, 171, 70, 47, 10
          CButton* mfc25 = new CButton(parent);
          CRect r25(CPoint(171, 70), CSize(47, 10));
          parent->MapDialogRect(&r25);
          mfc25->Create(_T("Sustained"), 0|WS_TABSTOP, r25, parent, IDC_C_EG);
          mfcToQtWidget->insert(IDC_C_EG, mfc25);
      

          // CONTROL "Key scaling", IDC_C_KSR, "Button", BS_AUTORADIOBUTTON, 171, 86, 51, 10
          CButton* mfc26 = new CButton(parent);
          CRect r26(CPoint(171, 86), CSize(51, 10));
          parent->MapDialogRect(&r26);
          mfc26->Create(_T("Key scaling"), 0|WS_TABSTOP, r26, parent, IDC_C_KSR);
          mfcToQtWidget->insert(IDC_C_KSR, mfc26);
      

          // CONTROL "Wave rectification", IDC_C_DM, "Button", BS_AUTORADIOBUTTON, 232, 70, 74, 10
          CButton* mfc27 = new CButton(parent);
          CRect r27(CPoint(232, 70), CSize(74, 10));
          parent->MapDialogRect(&r27);
          mfc27->Create(_T("Wave rectification"), 0|WS_TABSTOP, r27, parent, IDC_C_DM);
         ...
         parent->MapDialogRect(&r28);
         mfc28->Create(_T("Level"),0,r28,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_C_KSL, "msctls_trackbar32", BS_AUTORADIOBUTTON, 247, 86, 59, 11
          CSliderCtrl* mfc29 = new CSliderCtrl(parent);
          CRect r29(CPoint(247, 86), CSize(59, 11));
          parent->MapDialogRect(&r29);
          mfc29->Create(0|WS_TABSTOP, r29, parent, IDC_C_KSL);
         ...
         parent->MapDialogRect(&r30);
         mfc30->Create(_T("Mult. factor"),0,r30,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_C_MUL, "msctls_trackbar32", BS_AUTORADIOBUTTON, 208, 107, 106, 11
          CSliderCtrl* mfc31 = new CSliderCtrl(parent);
          CRect r31(CPoint(208, 107), CSize(106, 11));
          parent->MapDialogRect(&r31);
          mfc31->Create(0|WS_TABSTOP, r31, parent, IDC_C_MUL);
         ...
         mfc32->Create(_T("Attack"),0,r32,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_C_AR, "msctls_trackbar32", BS_AUTORADIOBUTTON, 199, 126, 42, 11
          CSliderCtrl* mfc33 = new CSliderCtrl(parent);
          CRect r33(CPoint(199, 126), CSize(42, 11));
          parent->MapDialogRect(&r33);
          mfc33->Create(0|WS_TABSTOP, r33, parent, IDC_C_AR);
         ...
         mfc34->Create(_T("Decay"),0,r34,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_C_DR, "msctls_trackbar32", BS_AUTORADIOBUTTON, 271, 126, 43, 11
          CSliderCtrl* mfc35 = new CSliderCtrl(parent);
          CRect r35(CPoint(271, 126), CSize(43, 11));
          parent->MapDialogRect(&r35);
          mfc35->Create(0|WS_TABSTOP, r35, parent, IDC_C_DR);
         ...
         mfc36->Create(_T("Sustain"),0,r36,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_C_SL, "msctls_trackbar32", BS_AUTORADIOBUTTON, 199, 143, 42, 11
          CSliderCtrl* mfc37 = new CSliderCtrl(parent);
          CRect r37(CPoint(199, 143), CSize(42, 11));
          parent->MapDialogRect(&r37);
          mfc37->Create(0|WS_TABSTOP, r37, parent, IDC_C_SL);
         ...
         mfc38->Create(_T("Release"),0,r38,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_C_RR, "msctls_trackbar32", BS_AUTORADIOBUTTON, 271, 143, 43, 11
          CSliderCtrl* mfc39 = new CSliderCtrl(parent);
          CRect r39(CPoint(271, 143), CSize(43, 11));
          parent->MapDialogRect(&r39);
          mfc39->Create(0|WS_TABSTOP, r39, parent, IDC_C_RR);
         ...
         mfc40->Create(_T("Modulator\nlevel"),0,r40,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_TL, "msctls_trackbar32", BS_AUTORADIOBUTTON, 329, 59, 16, 53
          CSliderCtrl* mfc41 = new CSliderCtrl(parent);
          CRect r41(CPoint(329, 59), CSize(16, 53));
          parent->MapDialogRect(&r41);
          mfc41->Create(0|WS_TABSTOP, r41, parent, IDC_TL);
         ...
         mfc42->Create(_T("Feedback"),0,r42,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_FB, "msctls_trackbar32", BS_AUTORADIOBUTTON, 325, 124, 25, 41
          CSliderCtrl* mfc43 = new CSliderCtrl(parent);
          CRect r43(CPoint(325, 124), CSize(25, 41));
          parent->MapDialogRect(&r43);
          mfc43->Create(0|WS_TABSTOP, r43, parent, IDC_FB);
   ...
   void qtMfcInitDialogResource_IDD_CREATEWAV(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         // DEFPUSHBUTTON "Begin",0,37,187,52,14
         CButton* mfc0 = new CButton(parent);
         CRect r0(CPoint(37,187),CSize(52,14));
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("Begin"),0,r0,parent,IDC_BEGIN);
         mfcToQtWidget->insert(IDC_BEGIN,mfc0);
       

         // PUSHBUTTON "Cancel",IDCANCEL,92,187,52,14,0
         CButton* mfc1 = new CButton(parent);
         CRect r1(CPoint(92,187),CSize(52,14));
         parent->MapDialogRect(&r1);
         mfc1->Create(_T("Cancel"),0,r1,parent,IDCANCEL);
         ...
         parent->MapDialogRect(&r2);
         mfc2->Create(_T("Song length"),0,r2,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
          ...
          parent->MapDialogRect(&r3);
          mfc3->Create(_T("Play the song"), 0|BS_AUTORADIOBUTTON, r3, parent, IDC_RADIO_LOOP);
          ...
          parent->MapDialogRect(&r4);
          mfc4->Create(_T("Play for"), 0|BS_AUTORADIOBUTTON, r4, parent, IDC_RADIO_TIME);
          mfcToQtWidget->insert(IDC_RADIO_TIME, mfc4);
      

         // EDITTEXT IDC_TIMES,73,19,36,12,0|ES_AUTOHSCROLL
         CEdit* mfc5 = new CEdit(parent);
         CRect r5(CPoint(73,19),CSize(36,12));
         parent->MapDialogRect(&r5);
         mfc5->Create(0|ES_AUTOHSCROLL,r5,parent,IDC_TIMES);
         mfcToQtWidget->insert(IDC_TIMES,mfc5);
       

          // CONTROL "", IDC_SPIN_LOOP, "msctls_updown32", BS_AUTORADIOBUTTON, 105, 17, 11, 17
          CSpinButtonCtrl* mfc6 = new CSpinButtonCtrl(parent);
          CRect r6(CPoint(105, 17), CSize(11, 17));
          parent->MapDialogRect(&r6);
          mfc6->Create(0|UDS_ARROWKEYS, r6, parent, IDC_SPIN_LOOP);
         ...
         parent->MapDialogRect(&r7);
         mfc7->Create(_T("time(s)"),0|SS_CENTERIMAGE,r7,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // EDITTEXT IDC_SECONDS,53,37,44,12,0|ES_AUTOHSCROLL
         CEdit* mfc8 = new CEdit(parent);
         CRect r8(CPoint(53,37),CSize(44,12));
         parent->MapDialogRect(&r8);
         mfc8->Create(0|ES_AUTOHSCROLL,r8,parent,IDC_SECONDS);
         mfcToQtWidget->insert(IDC_SECONDS,mfc8);
       

          // CONTROL "", IDC_SPIN_TIME, "msctls_updown32", BS_AUTORADIOBUTTON, 93, 36, 11, 14
          CSpinButtonCtrl* mfc9 = new CSpinButtonCtrl(parent);
          CRect r9(CPoint(93, 36), CSize(11, 14));
          parent->MapDialogRect(&r9);
          mfc9->Create(0|UDS_ARROWKEYS, r9, parent, IDC_SPIN_TIME);
         ...
         parent->MapDialogRect(&r10);
         mfc10->Create(_T("mm:ss"),0|SS_CENTERIMAGE,r10,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r11);
         mfc11->Create(_T("Channels"),0,r11,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // LISTBOX IDC_CHANNELS,14,107,124,70,0|WS_TABSTOP
         CListBox* mfc12 = new CListBox(parent);
         CRect r12(CPoint(14,107),CSize(124,70));
         parent->MapDialogRect(&r12);
         mfc12->Create(0|WS_TABSTOP,r12,parent,IDC_CHANNELS);
         ...
         parent->MapDialogRect(&r13);
         mfc13->Create(_T("Song"),0,r13,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // COMBOBOX IDC_TRACKS,14,72,124,30,0|WS_TABSTOP
         CComboBox* mfc14 = new CComboBox(parent);
         CRect r14(CPoint(14,72),CSize(124,30));
         parent->MapDialogRect(&r14);
         mfc14->Create(0|WS_TABSTOP,r14,parent,IDC_TRACKS);
   ...
   void qtMfcInitDialogResource_IDD_INSTRUMENT_FDS(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("Wave editor"),0,r0,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // PUSHBUTTON "Sine",IDC_PRESET_SINE,14,101,41,12,0
         CButton* mfc1 = new CButton(parent);
         CRect r1(CPoint(14,101),CSize(41,12));
         parent->MapDialogRect(&r1);
         mfc1->Create(_T("Sine"),0,r1,parent,IDC_PRESET_SINE);
         mfcToQtWidget->insert(IDC_PRESET_SINE,mfc1);
       

         // PUSHBUTTON "Triangle",IDC_PRESET_TRIANGLE,57,101,41,12,0
         CButton* mfc2 = new CButton(parent);
         CRect r2(CPoint(57,101),CSize(41,12));
         parent->MapDialogRect(&r2);
         mfc2->Create(_T("Triangle"),0,r2,parent,IDC_PRESET_TRIANGLE);
         mfcToQtWidget->insert(IDC_PRESET_TRIANGLE,mfc2);
       

         // PUSHBUTTON "Sawtooth",IDC_PRESET_SAWTOOTH,100,101,41,12,0
         CButton* mfc3 = new CButton(parent);
         CRect r3(CPoint(100,101),CSize(41,12));
         parent->MapDialogRect(&r3);
         mfc3->Create(_T("Sawtooth"),0,r3,parent,IDC_PRESET_SAWTOOTH);
         ...
         parent->MapDialogRect(&r4);
         mfc4->Create(_T("Modulation rate"),0,r4,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // EDITTEXT IDC_MOD_RATE,318,22,37,14,0|ES_NUMBER
         CEdit* mfc5 = new CEdit(parent);
         CRect r5(CPoint(318,22),CSize(37,14));
         parent->MapDialogRect(&r5);
         mfc5->Create(0|ES_NUMBER,r5,parent,IDC_MOD_RATE);
         mfcToQtWidget->insert(IDC_MOD_RATE,mfc5);
       

          // CONTROL "", IDC_MOD_RATE_SPIN, "msctls_updown32", BS_AUTORADIOBUTTON, 344, 25, 11, 14
          CSpinButtonCtrl* mfc6 = new CSpinButtonCtrl(parent);
          CRect r6(CPoint(344, 25), CSize(11, 14));
          parent->MapDialogRect(&r6);
          mfc6->Create(0|UDS_NOTHOUSANDS, r6, parent, IDC_MOD_RATE_SPIN);
         ...
         parent->MapDialogRect(&r7);
         mfc7->Create(_T("Modulation depth"),0,r7,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // EDITTEXT IDC_MOD_DEPTH,318,43,37,14,0|ES_NUMBER
         CEdit* mfc8 = new CEdit(parent);
         CRect r8(CPoint(318,43),CSize(37,14));
         parent->MapDialogRect(&r8);
         mfc8->Create(0|ES_NUMBER,r8,parent,IDC_MOD_DEPTH);
         mfcToQtWidget->insert(IDC_MOD_DEPTH,mfc8);
       

          // CONTROL "", IDC_MOD_DEPTH_SPIN, "msctls_updown32", BS_AUTORADIOBUTTON, 344, 43, 11, 14
          CSpinButtonCtrl* mfc9 = new CSpinButtonCtrl(parent);
          CRect r9(CPoint(344, 43), CSize(11, 14));
          parent->MapDialogRect(&r9);
          mfc9->Create(0|UDS_ARROWKEYS, r9, parent, IDC_MOD_DEPTH_SPIN);
         ...
         parent->MapDialogRect(&r10);
         mfc10->Create(_T("Modulation delay"),0,r10,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // EDITTEXT IDC_MOD_DELAY,318,65,37,14,0|ES_NUMBER
         CEdit* mfc11 = new CEdit(parent);
         CRect r11(CPoint(318,65),CSize(37,14));
         parent->MapDialogRect(&r11);
         mfc11->Create(0|ES_NUMBER,r11,parent,IDC_MOD_DELAY);
         mfcToQtWidget->insert(IDC_MOD_DELAY,mfc11);
       

          // CONTROL "", IDC_MOD_DELAY_SPIN, "msctls_updown32", BS_AUTORADIOBUTTON, 344, 63, 11, 14
          CSpinButtonCtrl* mfc12 = new CSpinButtonCtrl(parent);
          CRect r12(CPoint(344, 63), CSize(11, 14));
          parent->MapDialogRect(&r12);
          mfc12->Create(0|UDS_ARROWKEYS, r12, parent, IDC_MOD_DELAY_SPIN);
          mfcToQtWidget->insert(IDC_MOD_DELAY_SPIN, mfc12);
      

         // PUSHBUTTON "Flat",IDC_MOD_PRESET_FLAT,318,131,46,12,0
         CButton* mfc13 = new CButton(parent);
         CRect r13(CPoint(318,131),CSize(46,12));
         parent->MapDialogRect(&r13);
         mfc13->Create(_T("Flat"),0,r13,parent,IDC_MOD_PRESET_FLAT);
         mfcToQtWidget->insert(IDC_MOD_PRESET_FLAT,mfc13);
       

         // PUSHBUTTON "Sine",IDC_MOD_PRESET_SINE,318,148,46,12,0
         CButton* mfc14 = new CButton(parent);
         CRect r14(CPoint(318,148),CSize(46,12));
         parent->MapDialogRect(&r14);
         mfc14->Create(_T("Sine"),0,r14,parent,IDC_MOD_PRESET_SINE);
         ...
         parent->MapDialogRect(&r15);
         mfc15->Create(_T("Frequency modulation"),0,r15,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // PUSHBUTTON "Copy wave",IDC_COPY_WAVE,240,90,52,14,0
         CButton* mfc16 = new CButton(parent);
         CRect r16(CPoint(240,90),CSize(52,14));
         parent->MapDialogRect(&r16);
         mfc16->Create(_T("Copy wave"),0,r16,parent,IDC_COPY_WAVE);
         mfcToQtWidget->insert(IDC_COPY_WAVE,mfc16);
       

         // PUSHBUTTON "Paste wave",IDC_PASTE_WAVE,240,104,52,14,0
         CButton* mfc17 = new CButton(parent);
         CRect r17(CPoint(240,104),CSize(52,14));
         parent->MapDialogRect(&r17);
         mfc17->Create(_T("Paste wave"),0,r17,parent,IDC_PASTE_WAVE);
         mfcToQtWidget->insert(IDC_PASTE_WAVE,mfc17);
       

         // PUSHBUTTON "Copy table",IDC_COPY_TABLE,305,90,50,14,0
         CButton* mfc18 = new CButton(parent);
         CRect r18(CPoint(305,90),CSize(50,14));
         parent->MapDialogRect(&r18);
         mfc18->Create(_T("Copy table"),0,r18,parent,IDC_COPY_TABLE);
         mfcToQtWidget->insert(IDC_COPY_TABLE,mfc18);
       

         // PUSHBUTTON "Paste table",IDC_PASTE_TABLE,305,104,50,14,0
         CButton* mfc19 = new CButton(parent);
         CRect r19(CPoint(305,104),CSize(50,14));
         parent->MapDialogRect(&r19);
         mfc19->Create(_T("Paste table"),0,r19,parent,IDC_PASTE_TABLE);
         mfcToQtWidget->insert(IDC_PASTE_TABLE,mfc19);
       

         // PUSHBUTTON "50% pulse",IDC_PRESET_PULSE_50,143,101,41,12,0
         CButton* mfc20 = new CButton(parent);
         CRect r20(CPoint(143,101),CSize(41,12));
         parent->MapDialogRect(&r20);
         mfc20->Create(_T("50% pulse"),0,r20,parent,IDC_PRESET_PULSE_50);
         mfcToQtWidget->insert(IDC_PRESET_PULSE_50,mfc20);
       

         // PUSHBUTTON "25% pulse",IDC_PRESET_PULSE_25,186,101,41,12,0
         CButton* mfc21 = new CButton(parent);
         CRect r21(CPoint(186,101),CSize(41,12));
         parent->MapDialogRect(&r21);
         mfc21->Create(_T("25% pulse"),0,r21,parent,IDC_PRESET_PULSE_25);
   ...
   void qtMfcInitDialogResource_IDD_FRAMECONTROLS(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         // PUSHBUTTON "+",IDC_FRAME_INC,0,0,17,12,0
         CButton* mfc0 = new CButton(parent);
         CRect r0(CPoint(0,0),CSize(17,12));
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("+"),0,r0,parent,IDC_FRAME_INC);
         mfcToQtWidget->insert(IDC_FRAME_INC,mfc0);
       

         // PUSHBUTTON "-",IDC_FRAME_DEC,23,0,17,12,0
         CButton* mfc1 = new CButton(parent);
         CRect r1(CPoint(23,0),CSize(17,12));
         parent->MapDialogRect(&r1);
         mfc1->Create(_T("-"),0,r1,parent,IDC_FRAME_DEC);
         mfcToQtWidget->insert(IDC_FRAME_DEC,mfc1);
       

          // CONTROL "Change all", IDC_CHANGE_ALL, "Button", BS_AUTORADIOBUTTON, 51, 2, 56, 10
          CButton* mfc2 = new CButton(parent);
          CRect r2(CPoint(51, 2), CSize(56, 10));
          parent->MapDialogRect(&r2);
          mfc2->Create(_T("Change all"), 0|WS_TABSTOP, r2, parent, IDC_CHANGE_ALL);
   ...
   void qtMfcInitDialogResource_IDD_INSTRUMENT_FDS_ENVELOPE(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         // EDITTEXT IDC_SEQUENCE_STRING,75,151,290,14,0|ES_AUTOHSCROLL
         CEdit* mfc0 = new CEdit(parent);
         CRect r0(CPoint(75,151),CSize(290,14));
         parent->MapDialogRect(&r0);
         mfc0->Create(0|ES_AUTOHSCROLL,r0,parent,IDC_SEQUENCE_STRING);
         mfcToQtWidget->insert(IDC_SEQUENCE_STRING,mfc0);
       

         // COMBOBOX IDC_TYPE,8,151,63,30,0|WS_TABSTOP
         CComboBox* mfc1 = new CComboBox(parent);
         CRect r1(CPoint(8,151),CSize(63,30));
         parent->MapDialogRect(&r1);
         mfc1->Create(0|WS_TABSTOP,r1,parent,IDC_TYPE);
   ...
   void qtMfcInitDialogResource_IDD_CHANNELS(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         // DEFPUSHBUTTON "OK",0,194,215,50,14
         CButton* mfc0 = new CButton(parent);
         CRect r0(CPoint(194,215),CSize(50,14));
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("OK"),0,r0,parent,IDOK);
         mfcToQtWidget->insert(IDOK,mfc0);
       

         // PUSHBUTTON "Cancel",IDCANCEL,246,215,50,14,0
         CButton* mfc1 = new CButton(parent);
         ...
         // PUSHBUTTON "Move up",IDC_MOVE_UP,7,215,50,14,0
         CButton* mfc2 = new CButton(parent);
         CRect r2(CPoint(7,215),CSize(50,14));
         parent->MapDialogRect(&r2);
         mfc2->Create(_T("Move up"),0,r2,parent,IDC_MOVE_UP);
         mfcToQtWidget->insert(IDC_MOVE_UP,mfc2);
       

         // PUSHBUTTON "Move down",IDC_MOVE_DOWN,62,215,50,14,0
         CButton* mfc3 = new CButton(parent);
         CRect r3(CPoint(62,215),CSize(50,14));
         parent->MapDialogRect(&r3);
         mfc3->Create(_T("Move down"),0,r3,parent,IDC_MOVE_DOWN);
         mfcToQtWidget->insert(IDC_MOVE_DOWN,mfc3);
       

          // CONTROL "", IDC_ADDED_LIST, "SysListView32", BS_AUTORADIOBUTTON, 159, 17, 129, 181
          CListCtrl* mfc4 = new CListCtrl(parent);
          CRect r4(CPoint(159, 17), CSize(129, 181));
          parent->MapDialogRect(&r4);
          mfc4->Create(0|WS_TABSTOP, r4, parent, IDC_ADDED_LIST);
          mfcToQtWidget->insert(IDC_ADDED_LIST, mfc4);
      

          // CONTROL "", IDC_STATIC, "Static", BS_AUTORADIOBUTTON, 7, 209, 289, 1
          CStatic* mfc5 = new CStatic(parent);
          CRect r5(CPoint(7, 209), CSize(289, 1));
          parent->MapDialogRect(&r5);
          mfc5->Create(_T(""), 0|SS_ETCHEDHORZ, r5, parent, IDC_STATIC);
         ...
         parent->MapDialogRect(&r6);
         mfc6->Create(_T("Available channels"),0,r6,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r7);
         mfc7->Create(_T("Added channels"),0,r7,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

          // CONTROL "", IDC_AVAILABLE_TREE, "SysTreeView32", BS_AUTORADIOBUTTON, 14, 17, 122, 181
          CTreeCtrl* mfc8 = new CTreeCtrl(parent);
          CRect r8(CPoint(14, 17), CSize(122, 181));
          parent->MapDialogRect(&r8);
          mfc8->Create(0|WS_TABSTOP, r8, parent, IDC_AVAILABLE_TREE);
   ...
   void qtMfcInitDialogResource_IDD_COMMENTS(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         // PUSHBUTTON "Cancel",IDCANCEL,304,211,50,14,0
         CButton* mfc0 = new CButton(parent);
         CRect r0(CPoint(304,211),CSize(50,14));
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("Cancel"),0,r0,parent,IDCANCEL);
         mfcToQtWidget->insert(IDCANCEL,mfc0);
       

         // EDITTEXT IDC_COMMENTS,0,0,358,206,0|WS_HSCROLL
         CEdit* mfc1 = new CEdit(parent);
         CRect r1(CPoint(0,0),CSize(358,206));
         parent->MapDialogRect(&r1);
         mfc1->Create(0|WS_HSCROLL,r1,parent,IDC_COMMENTS);
         mfcToQtWidget->insert(IDC_COMMENTS,mfc1);
       

          // CONTROL "Show when loading file", IDC_SHOWONOPEN, "Button", BS_AUTORADIOBUTTON, 5, 215, 89, 10
          CButton* mfc2 = new CButton(parent);
          CRect r2(CPoint(5, 215), CSize(89, 10));
          parent->MapDialogRect(&r2);
          mfc2->Create(_T("Show when loading file"), 0|WS_TABSTOP, r2, parent, IDC_SHOWONOPEN);
          mfcToQtWidget->insert(IDC_SHOWONOPEN, mfc2);
      

         // DEFPUSHBUTTON "OK",0,248,211,50,14
         CButton* mfc3 = new CButton(parent);
         CRect r3(CPoint(248,211),CSize(50,14));
         parent->MapDialogRect(&r3);
         mfc3->Create(_T("OK"),0,r3,parent,IDOK);
   ...
   void qtMfcInitDialogResource_IDD_CONFIG_MIXER(CDialog* parent)
   {
      ...
      // BEGIN
          ...
          // CONTROL "", IDC_SLIDER_APU1, "msctls_trackbar32", BS_AUTORADIOBUTTON, 7, 30, 26, 114
          CSliderCtrl* mfc0 = new CSliderCtrl(parent);
          CRect r0(CPoint(7, 30), CSize(26, 114));
          parent->MapDialogRect(&r0);
          mfc0->Create(0|WS_TABSTOP, r0, parent, IDC_SLIDER_APU1);
         ...
         parent->MapDialogRect(&r1);
         mfc1->Create(_T("APU1"),0,r1,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_SLIDER_APU2, "msctls_trackbar32", BS_AUTORADIOBUTTON, 41, 30, 26, 114
          CSliderCtrl* mfc2 = new CSliderCtrl(parent);
          CRect r2(CPoint(41, 30), CSize(26, 114));
          parent->MapDialogRect(&r2);
          mfc2->Create(0|WS_TABSTOP, r2, parent, IDC_SLIDER_APU2);
         ...
         parent->MapDialogRect(&r3);
         mfc3->Create(_T("APU2"),0,r3,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_SLIDER_VRC6, "msctls_trackbar32", BS_AUTORADIOBUTTON, 75, 30, 26, 114
          CSliderCtrl* mfc4 = new CSliderCtrl(parent);
          CRect r4(CPoint(75, 30), CSize(26, 114));
          parent->MapDialogRect(&r4);
          mfc4->Create(0|WS_TABSTOP, r4, parent, IDC_SLIDER_VRC6);
         ...
         parent->MapDialogRect(&r5);
         mfc5->Create(_T("VRC6"),0,r5,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_SLIDER_VRC7, "msctls_trackbar32", BS_AUTORADIOBUTTON, 109, 30, 26, 114
          CSliderCtrl* mfc6 = new CSliderCtrl(parent);
          CRect r6(CPoint(109, 30), CSize(26, 114));
          parent->MapDialogRect(&r6);
          mfc6->Create(0|WS_TABSTOP, r6, parent, IDC_SLIDER_VRC7);
         ...
         parent->MapDialogRect(&r7);
         mfc7->Create(_T("VRC7"),0,r7,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_SLIDER_MMC5, "msctls_trackbar32", BS_AUTORADIOBUTTON, 143, 30, 26, 114
          CSliderCtrl* mfc8 = new CSliderCtrl(parent);
          CRect r8(CPoint(143, 30), CSize(26, 114));
          parent->MapDialogRect(&r8);
          mfc8->Create(0|WS_TABSTOP, r8, parent, IDC_SLIDER_MMC5);
         ...
         parent->MapDialogRect(&r9);
         mfc9->Create(_T("MMC5"),0,r9,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_SLIDER_FDS, "msctls_trackbar32", BS_AUTORADIOBUTTON, 177, 30, 26, 114
          CSliderCtrl* mfc10 = new CSliderCtrl(parent);
          CRect r10(CPoint(177, 30), CSize(26, 114));
          parent->MapDialogRect(&r10);
          mfc10->Create(0|WS_TABSTOP, r10, parent, IDC_SLIDER_FDS);
         ...
         parent->MapDialogRect(&r11);
         mfc11->Create(_T("FDS"),0,r11,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_SLIDER_N163, "msctls_trackbar32", BS_AUTORADIOBUTTON, 211, 30, 26, 114
          CSliderCtrl* mfc12 = new CSliderCtrl(parent);
          CRect r12(CPoint(211, 30), CSize(26, 114));
          parent->MapDialogRect(&r12);
          mfc12->Create(0|WS_TABSTOP, r12, parent, IDC_SLIDER_N163);
         ...
         parent->MapDialogRect(&r13);
         mfc13->Create(_T("N163"),0,r13,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_SLIDER_S5B, "msctls_trackbar32", BS_AUTORADIOBUTTON, 245, 30, 26, 114
          CSliderCtrl* mfc14 = new CSliderCtrl(parent);
          CRect r14(CPoint(245, 30), CSize(26, 114));
          parent->MapDialogRect(&r14);
          mfc14->Create(0|WS_TABSTOP, r14, parent, IDC_SLIDER_S5B);
         ...
         parent->MapDialogRect(&r15);
         mfc15->Create(_T("S5B"),0,r15,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r16);
         mfc16->Create(_T("0.0dB"),0,r16,parent,IDC_LEVEL_APU1);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r17);
         mfc17->Create(_T("0.0dB"),0,r17,parent,IDC_LEVEL_APU2);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r18);
         mfc18->Create(_T("0.0dB"),0,r18,parent,IDC_LEVEL_VRC6);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r19);
         mfc19->Create(_T("0.0dB"),0,r19,parent,IDC_LEVEL_VRC7);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r20);
         mfc20->Create(_T("0.0dB"),0,r20,parent,IDC_LEVEL_MMC5);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r21);
         mfc21->Create(_T("0.0dB"),0,r21,parent,IDC_LEVEL_FDS);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r22);
         mfc22->Create(_T("0.0dB"),0,r22,parent,IDC_LEVEL_N163);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r23);
         mfc23->Create(_T("0.0dB"),0,r23,parent,IDC_LEVEL_S5B);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r24);
         mfc24->Create(_T("Hardware mixing levels"),0,r24,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
   ...
   void qtMfcInitDialogResource_IDD_INSTRUMENT_N163_WAVE(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         // PUSHBUTTON "Sine",IDC_PRESET_SINE,14,104,41,14,0
         CButton* mfc1 = new CButton(parent);
         ...
         // PUSHBUTTON "Triangle",IDC_PRESET_TRIANGLE,57,104,41,14,0
         CButton* mfc2 = new CButton(parent);
         ...
         // PUSHBUTTON "Sawtooth",IDC_PRESET_SAWTOOTH,100,104,41,14,0
         CButton* mfc3 = new CButton(parent);
         ...
         // PUSHBUTTON "50% pulse",IDC_PRESET_PULSE_50,143,104,41,14,0
         CButton* mfc4 = new CButton(parent);
         CRect r4(CPoint(143,104),CSize(41,14));
         parent->MapDialogRect(&r4);
         mfc4->Create(_T("50% pulse"),0,r4,parent,IDC_PRESET_PULSE_50);
         mfcToQtWidget->insert(IDC_PRESET_PULSE_50,mfc4);
       

         // PUSHBUTTON "25% pulse",IDC_PRESET_PULSE_25,186,104,41,14,0
         CButton* mfc5 = new CButton(parent);
         CRect r5(CPoint(186,104),CSize(41,14));
         parent->MapDialogRect(&r5);
         mfc5->Create(_T("25% pulse"),0,r5,parent,IDC_PRESET_PULSE_25);
         ...
         parent->MapDialogRect(&r6);
         mfc6->Create(_T("MML string"),0,r6,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // EDITTEXT IDC_MML,16,145,342,14,0|ES_AUTOHSCROLL
         CEdit* mfc7 = new CEdit(parent);
         CRect r7(CPoint(16,145),CSize(342,14));
         parent->MapDialogRect(&r7);
         mfc7->Create(0|ES_AUTOHSCROLL,r7,parent,IDC_MML);
         mfcToQtWidget->insert(IDC_MML,mfc7);
       

         // PUSHBUTTON "Copy wave",IDC_COPY,249,105,50,14,0
         CButton* mfc8 = new CButton(parent);
         CRect r8(CPoint(249,105),CSize(50,14));
         parent->MapDialogRect(&r8);
         mfc8->Create(_T("Copy wave"),0,r8,parent,IDC_COPY);
         mfcToQtWidget->insert(IDC_COPY,mfc8);
       

         // PUSHBUTTON "Paste wave",IDC_PASTE,308,105,50,14,0
         CButton* mfc9 = new CButton(parent);
         CRect r9(CPoint(308,105),CSize(50,14));
         parent->MapDialogRect(&r9);
         mfc9->Create(_T("Paste wave"),0,r9,parent,IDC_PASTE);
         mfcToQtWidget->insert(IDC_PASTE,mfc9);
       

         // EDITTEXT IDC_INDEX,253,20,39,12,0|ES_READONLY
         CEdit* mfc10 = new CEdit(parent);
         CRect r10(CPoint(253,20),CSize(39,12));
         parent->MapDialogRect(&r10);
         mfc10->Create(0|ES_READONLY,r10,parent,IDC_INDEX);
         mfcToQtWidget->insert(IDC_INDEX,mfc10);
       

          // CONTROL "", IDC_INDEX_SPIN, "msctls_updown32", BS_AUTORADIOBUTTON, 281, 26, 11, 14
          CSpinButtonCtrl* mfc11 = new CSpinButtonCtrl(parent);
          CRect r11(CPoint(281, 26), CSize(11, 14));
          parent->MapDialogRect(&r11);
          mfc11->Create(0|UDS_ARROWKEYS, r11, parent, IDC_INDEX_SPIN);
         ...
         parent->MapDialogRect(&r12);
         mfc12->Create(_T("of"),0,r12,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // EDITTEXT IDC_WAVES,316,20,37,12,0|ES_READONLY
         CEdit* mfc13 = new CEdit(parent);
         CRect r13(CPoint(316,20),CSize(37,12));
         parent->MapDialogRect(&r13);
         mfc13->Create(0|ES_READONLY,r13,parent,IDC_WAVES);
         mfcToQtWidget->insert(IDC_WAVES,mfc13);
       

          // CONTROL "", IDC_WAVES_SPIN, "msctls_updown32", BS_AUTORADIOBUTTON, 342, 19, 11, 14
          CSpinButtonCtrl* mfc14 = new CSpinButtonCtrl(parent);
          CRect r14(CPoint(342, 19), CSize(11, 14));
          parent->MapDialogRect(&r14);
          mfc14->Create(0|UDS_ARROWKEYS, r14, parent, IDC_WAVES_SPIN);
         ...
         parent->MapDialogRect(&r15);
         mfc15->Create(_T("Wave RAM settings"),0,r15,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r16);
         mfc16->Create(_T("Wave size"),0,r16,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // COMBOBOX IDC_WAVE_SIZE,305,57,48,30,0|WS_TABSTOP
         CComboBox* mfc17 = new CComboBox(parent);
         CRect r17(CPoint(305,57),CSize(48,30));
         parent->MapDialogRect(&r17);
         mfc17->Create(0|WS_TABSTOP,r17,parent,IDC_WAVE_SIZE);
         ...
         parent->MapDialogRect(&r18);
         mfc18->Create(_T("Wave position"),0,r18,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // COMBOBOX IDC_WAVE_POS,305,75,48,30,0|WS_TABSTOP
         CComboBox* mfc19 = new CComboBox(parent);
         CRect r19(CPoint(305,75),CSize(48,30));
         parent->MapDialogRect(&r19);
         mfc19->Create(0|WS_TABSTOP,r19,parent,IDC_WAVE_POS);
         ...
         parent->MapDialogRect(&r20);
         mfc20->Create(_T("Wave #"),0,r20,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
   ...
   void qtMfcInitDialogResource_IDD_IMPORT(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         // DEFPUSHBUTTON "OK",0,51,188,50,14
         CButton* mfc0 = new CButton(parent);
         ...
         // PUSHBUTTON "Cancel",IDCANCEL,104,188,50,14,0
         CButton* mfc1 = new CButton(parent);
         ...
         parent->MapDialogRect(&r2);
         mfc2->Create(_T("Tracks"),0,r2,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

          // CONTROL "Include instruments", IDC_INSTRUMENTS, "Button", BS_AUTORADIOBUTTON, 14, 161, 116, 10
          CButton* mfc3 = new CButton(parent);
          CRect r3(CPoint(14, 161), CSize(116, 10));
          parent->MapDialogRect(&r3);
          mfc3->Create(_T("Include instruments"), 0|WS_TABSTOP, r3, parent, IDC_INSTRUMENTS);
          mfcToQtWidget->insert(IDC_INSTRUMENTS, mfc3);
      

          // CONTROL "", IDC_STATIC, "Static", BS_AUTORADIOBUTTON, 7, 183, 147, 1
          CStatic* mfc4 = new CStatic(parent);
          CRect r4(CPoint(7, 183), CSize(147, 1));
          parent->MapDialogRect(&r4);
          mfc4->Create(_T(""), 0|SS_ETCHEDHORZ, r4, parent, IDC_STATIC);
         ...
         parent->MapDialogRect(&r5);
         mfc5->Create(_T("Options"),0,r5,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // LISTBOX IDC_TRACKS,14,18,133,120,0|WS_TABSTOP
         CListBox* mfc6 = new CListBox(parent);
         CRect r6(CPoint(14,18),CSize(133,120));
         parent->MapDialogRect(&r6);
         mfc6->Create(0|WS_TABSTOP,r6,parent,IDC_TRACKS);
   ...
   void qtMfcInitDialogResource_IDD_PERFORMANCE(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         // DEFPUSHBUTTON "Close",0,58,74,60,14
         CButton* mfc0 = new CButton(parent);
         CRect r0(CPoint(58,74),CSize(60,14));
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("Close"),0,r0,parent,IDOK);
         mfcToQtWidget->insert(IDOK,mfc0);
         ...
         parent->MapDialogRect(&r1);
         mfc1->Create(_T("CPU usage"),0,r1,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r2);
         mfc2->Create(_T("--%"),0,r2,parent,IDC_CPU);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_CPU_BAR, "msctls_progress32", BS_AUTORADIOBUTTON, 18, 19, 18, 34
          CProgressCtrl* mfc3 = new CProgressCtrl(parent);
          CRect r3(CPoint(18, 19), CSize(18, 34));
          parent->MapDialogRect(&r3);
          mfc3->Create(0|WS_BORDER, r3, parent, IDC_CPU_BAR);
         ...
         parent->MapDialogRect(&r4);
         mfc4->Create(_T("Frame rate: 0 Hz"),0,r4,parent,IDC_FRAMERATE);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r5);
         mfc5->Create(_T("Underruns: 0"),0,r5,parent,IDC_UNDERRUN);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_STATIC, "Static", BS_AUTORADIOBUTTON, 7, 67, 162, 1
          CStatic* mfc6 = new CStatic(parent);
          CRect r6(CPoint(7, 67), CSize(162, 1));
          parent->MapDialogRect(&r6);
          mfc6->Create(_T(""), 0|SS_ETCHEDHORZ, r6, parent, IDC_STATIC);
          mfcToQtWidget->insert(IDC_STATIC, mfc6);
         ...
         parent->MapDialogRect(&r7);
         mfc7->Create(_T("Other"),0,r7,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r8);
         mfc8->Create(_T("Audio"),0,r8,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
   ...
   void qtMfcInitDialogResource_IDD_SPEED(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         // DEFPUSHBUTTON "OK",0,139,7,50,14
         CButton* mfc0 = new CButton(parent);
         ...
         // PUSHBUTTON "Cancel",IDCANCEL,139,23,50,14,0
         CButton* mfc1 = new CButton(parent);
         ...
         mfcToQtWidget->insert(IDCANCEL,mfc1);
          ...
          // CONTROL "", IDC_SPEED_SLD, "msctls_trackbar32", BS_AUTORADIOBUTTON, 7, 7, 101, 16
          CSliderCtrl* mfc2 = new CSliderCtrl(parent);
          CRect r2(CPoint(7, 7), CSize(101, 16));
          parent->MapDialogRect(&r2);
          mfc2->Create(0|WS_TABSTOP, r2, parent, IDC_SPEED_SLD);
         ...
         parent->MapDialogRect(&r3);
         mfc3->Create(_T("60 Hz"),0,r3,parent,IDC_SPEED);
         // IDC_STATIC do not get added to MFC-to-Qt map.
   ...
   void qtMfcInitDialogResource_IDD_PROPERTIES(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("Song editor"),0,r0,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

          // CONTROL "", IDC_SONGLIST, "SysListView32", BS_AUTORADIOBUTTON, 14, 18, 124, 114
          CListCtrl* mfc1 = new CListCtrl(parent);
          CRect r1(CPoint(14, 18), CSize(124, 114));
          parent->MapDialogRect(&r1);
          mfc1->Create(0|WS_TABSTOP, r1, parent, IDC_SONGLIST);
          mfcToQtWidget->insert(IDC_SONGLIST, mfc1);
      

         // PUSHBUTTON "Add",IDC_SONG_ADD,144,18,54,14,0
         CButton* mfc2 = new CButton(parent);
         CRect r2(CPoint(144,18),CSize(54,14));
         parent->MapDialogRect(&r2);
         mfc2->Create(_T("Add"),0,r2,parent,IDC_SONG_ADD);
         mfcToQtWidget->insert(IDC_SONG_ADD,mfc2);
       

         // PUSHBUTTON "Remove",IDC_SONG_REMOVE,144,35,54,14,0
         CButton* mfc3 = new CButton(parent);
         CRect r3(CPoint(144,35),CSize(54,14));
         parent->MapDialogRect(&r3);
         mfc3->Create(_T("Remove"),0,r3,parent,IDC_SONG_REMOVE);
         mfcToQtWidget->insert(IDC_SONG_REMOVE,mfc3);
       

         // PUSHBUTTON "Move up",IDC_SONG_UP,144,52,54,14,0
         CButton* mfc4 = new CButton(parent);
         CRect r4(CPoint(144,52),CSize(54,14));
         parent->MapDialogRect(&r4);
         mfc4->Create(_T("Move up"),0,r4,parent,IDC_SONG_UP);
         mfcToQtWidget->insert(IDC_SONG_UP,mfc4);
       

         // PUSHBUTTON "Move down",IDC_SONG_DOWN,144,69,54,14,0
         CButton* mfc5 = new CButton(parent);
         CRect r5(CPoint(144,69),CSize(54,14));
         parent->MapDialogRect(&r5);
         mfc5->Create(_T("Move down"),0,r5,parent,IDC_SONG_DOWN);
         mfcToQtWidget->insert(IDC_SONG_DOWN,mfc5);
       

         // PUSHBUTTON "Import file",IDC_SONG_IMPORT,144,86,54,14,0
         CButton* mfc6 = new CButton(parent);
         CRect r6(CPoint(144,86),CSize(54,14));
         parent->MapDialogRect(&r6);
         mfc6->Create(_T("Import file"),0,r6,parent,IDC_SONG_IMPORT);
         ...
         parent->MapDialogRect(&r7);
         mfc7->Create(_T(" Title"),0|SS_CENTERIMAGE,r7,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // EDITTEXT IDC_SONGNAME,38,135,100,12,0|ES_AUTOHSCROLL
         CEdit* mfc8 = new CEdit(parent);
         CRect r8(CPoint(38,135),CSize(100,12));
         parent->MapDialogRect(&r8);
         mfc8->Create(0|ES_AUTOHSCROLL,r8,parent,IDC_SONGNAME);
         ...
         parent->MapDialogRect(&r9);
         mfc9->Create(_T("Expansion sound"),0,r9,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // COMBOBOX IDC_EXPANSION,14,173,113,61,0|WS_TABSTOP
         CComboBox* mfc10 = new CComboBox(parent);
         CRect r10(CPoint(14,173),CSize(113,61));
         parent->MapDialogRect(&r10);
         mfc10->Create(0|WS_TABSTOP,r10,parent,IDC_EXPANSION);
         ...
         parent->MapDialogRect(&r11);
         mfc11->Create(_T("Vibrato"),0,r11,parent,IDC_STATIC);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

         // COMBOBOX IDC_VIBRATO,14,204,184,61,0|WS_TABSTOP
         CComboBox* mfc12 = new CComboBox(parent);
         CRect r12(CPoint(14,204),CSize(184,61));
         parent->MapDialogRect(&r12);
         mfc12->Create(0|WS_TABSTOP,r12,parent,IDC_VIBRATO);
         mfcToQtWidget->insert(IDC_VIBRATO,mfc12);
       

          // CONTROL "", IDC_STATIC, "Static", BS_AUTORADIOBUTTON, 7, 231, 199, 1
          CStatic* mfc13 = new CStatic(parent);
          CRect r13(CPoint(7, 231), CSize(199, 1));
          parent->MapDialogRect(&r13);
          mfc13->Create(_T(""), 0|SS_ETCHEDHORZ, r13, parent, IDC_STATIC);
          mfcToQtWidget->insert(IDC_STATIC, mfc13);
      

         // DEFPUSHBUTTON "OK",0,95,238,53,14
         CButton* mfc14 = new CButton(parent);
         CRect r14(CPoint(95,238),CSize(53,14));
         parent->MapDialogRect(&r14);
         mfc14->Create(_T("OK"),0,r14,parent,IDOK);
         mfcToQtWidget->insert(IDOK,mfc14);
       

         // PUSHBUTTON "Cancel",IDCANCEL,153,238,53,14,0
         CButton* mfc15 = new CButton(parent);
         CRect r15(CPoint(153,238),CSize(53,14));
         parent->MapDialogRect(&r15);
         mfc15->Create(_T("Cancel"),0,r15,parent,IDCANCEL);
         ...
         parent->MapDialogRect(&r16);
         mfc16->Create(_T("Channels: 0"),0,r16,parent,IDC_CHANNELS_NR);
         // IDC_STATIC do not get added to MFC-to-Qt map.
       

          // CONTROL "", IDC_CHANNELS, "msctls_trackbar32", BS_AUTORADIOBUTTON, 147, 173, 51, 13
          CSliderCtrl* mfc17 = new CSliderCtrl(parent);
          CRect r17(CPoint(147, 173), CSize(51, 13));
          parent->MapDialogRect(&r17);
          mfc17->Create(0|WS_TABSTOP, r17, parent, IDC_CHANNELS);
   ...
   void qtMfcInitDialogResource_IDD_WAVE_PROGRESS(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         // PUSHBUTTON "Cancel",IDC_CANCEL,84,90,50,14,0
         CButton* mfc0 = new CButton(parent);
         CRect r0(CPoint(84,90),CSize(50,14));
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("Cancel"),0,r0,parent,IDC_CANCEL);
         mfcToQtWidget->insert(IDC_CANCEL,mfc0);
       

          // CONTROL "", IDC_PROGRESS_BAR, "msctls_progress32", BS_AUTORADIOBUTTON, 7, 65, 206, 12
          CProgressCtrl* mfc1 = new CProgressCtrl(parent);
          CRect r1(CPoint(7, 65), CSize(206, 12));
          parent->MapDialogRect(&r1);
          mfc1->Create(0|WS_BORDER, r1, parent, IDC_PROGRESS_BAR);
         ...
         parent->MapDialogRect(&r2);
         mfc2->Create(_T("Progress"),0,r2,parent,IDC_PROGRESS_LBL);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_STATIC, "Static", BS_AUTORADIOBUTTON, 7, 83, 206, 1
          CStatic* mfc3 = new CStatic(parent);
          CRect r3(CPoint(7, 83), CSize(206, 1));
          parent->MapDialogRect(&r3);
          mfc3->Create(_T(""), 0|SS_ETCHEDFRAME, r3, parent, IDC_STATIC);
          mfcToQtWidget->insert(IDC_STATIC, mfc3);
         ...
         parent->MapDialogRect(&r4);
         mfc4->Create(_T("File"),0|SS_CENTERIMAGE,r4,parent,IDC_PROGRESS_FILE);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "", IDC_STATIC, "Static", BS_AUTORADIOBUTTON, 7, 29, 206, 1
          CStatic* mfc5 = new CStatic(parent);
          CRect r5(CPoint(7, 29), CSize(206, 1));
          parent->MapDialogRect(&r5);
          mfc5->Create(_T(""), 0|SS_ETCHEDFRAME, r5, parent, IDC_STATIC);
          mfcToQtWidget->insert(IDC_STATIC, mfc5);
         ...
         parent->MapDialogRect(&r6);
         mfc6->Create(_T("Progress"),0,r6,parent,IDC_TIME);
         // IDC_STATIC do not get added to MFC-to-Qt map.
   ...
   void qtMfcInitDialogResource_IDD_SAMPLE_EDITOR(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         // DEFPUSHBUTTON "OK",0,424,217,50,14
         CButton* mfc0 = new CButton(parent);
         ...
         // PUSHBUTTON "Cancel",IDCANCEL,424,234,50,14,0
         CButton* mfc1 = new CButton(parent);
         ...
         mfcToQtWidget->insert(IDCANCEL,mfc1);
          ...
          // CONTROL "", IDC_SAMPLE, "Static", BS_AUTORADIOBUTTON, 7, 7, 467, 204
          CStatic* mfc2 = new CStatic(parent);
          CRect r2(CPoint(7, 7), CSize(467, 204));
          parent->MapDialogRect(&r2);
          mfc2->Create(_T(""), 0|SS_SUNKEN, r2, parent, IDC_SAMPLE);
          mfcToQtWidget->insert(IDC_SAMPLE, mfc2);
      

         // PUSHBUTTON "Play",IDC_PLAY,7,233,50,14,0
         CButton* mfc3 = new CButton(parent);
         CRect r3(CPoint(7,233),CSize(50,14));
         parent->MapDialogRect(&r3);
         mfc3->Create(_T("Play"),0,r3,parent,IDC_PLAY);
         ...
         parent->MapDialogRect(&r4);
         mfc4->Create(_T("Offset: 0, Pos: 0"),0|SS_SUNKEN,r4,parent,IDC_POS);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

         // PUSHBUTTON "Delete",IDC_DELETE,204,234,50,14,0
         CButton* mfc5 = new CButton(parent);
         CRect r5(CPoint(204,234),CSize(50,14));
         parent->MapDialogRect(&r5);
         mfc5->Create(_T("Delete"),0,r5,parent,IDC_DELETE);
         mfcToQtWidget->insert(IDC_DELETE,mfc5);
       

          // CONTROL "", IDC_PITCH, "msctls_trackbar32", BS_AUTORADIOBUTTON, 110, 236, 79, 12
          CSliderCtrl* mfc6 = new CSliderCtrl(parent);
         ...
         // PUSHBUTTON "Tilt",IDC_TILT,257,234,50,14,0
         CButton* mfc7 = new CButton(parent);
         CRect r7(CPoint(257,234),CSize(50,14));
         parent->MapDialogRect(&r7);
         mfc7->Create(_T("Tilt"),0,r7,parent,IDC_TILT);
         ...
         parent->MapDialogRect(&r8);
         mfc8->Create(_T("0 bytes"),0|SS_SUNKEN,r8,parent,IDC_INFO);
         // IDC_STATIC do not get added to MFC-to-Qt map.
         ...
         parent->MapDialogRect(&r9);
         mfc9->Create(_T("Pitch (15)"),0,r9,parent,IDC_STATIC_PITCH);
         // IDC_STATIC do not get added to MFC-to-Qt map.
      

          // CONTROL "Center wave", IDC_DELTASTART, "Button", BS_AUTORADIOBUTTON, 314, 238, 57, 10
          CButton* mfc10 = new CButton(parent);
          CRect r10(CPoint(314, 238), CSize(57, 10));
          parent->MapDialogRect(&r10);
          mfc10->Create(_T("Center wave"), 0|WS_TABSTOP, r10, parent, IDC_DELTASTART);
          mfcToQtWidget->insert(IDC_DELTASTART, mfc10);
      

          // CONTROL "", IDC_ZOOM, "msctls_trackbar32", BS_AUTORADIOBUTTON, 360, 217, 61, 12
          CSliderCtrl* mfc11 = new CSliderCtrl(parent);
          CRect r11(CPoint(360, 217), CSize(61, 12));
          parent->MapDialogRect(&r11);
          mfc11->Create(0|WS_TABSTOP, r11, parent, IDC_ZOOM);
   ...
   void qtMfcInitDialogResource_IDD_EXPORT_TEST(CDialog* parent)
   {
      ...
      // BEGIN
         ...
         // PUSHBUTTON "Abort",IDC_ABORT,60,7,50,14,0
         CButton* mfc0 = new CButton(parent);
         CRect r0(CPoint(60,7),CSize(50,14));
         parent->MapDialogRect(&r0);
         mfc0->Create(_T("Abort"),0,r0,parent,IDC_ABORT);
         mfcToQtWidget->insert(IDC_ABORT,mfc0);
       

         // PUSHBUTTON "Continue",IDC_CONTINUE,7,7,50,14,0
         CButton* mfc1 = new CButton(parent);
         CRect r1(CPoint(7,7),CSize(50,14));
         parent->MapDialogRect(&r1);
         mfc1->Create(_T("Continue"),0,r1,parent,IDC_CONTINUE);
   ...
   // BEGIN
      ...
      toolBarAction = new QAction(parent);
      toolBarActionPixmap = QPixmap::fromImage(toolBarImage.copy(22*16,0,16,15));
      toolBarAction->setIcon(QIcon(toolBarActionPixmap));
      ...
      // BUTTON ID_PREV_SONG
      toolBarAction = new QAction(parent);
      toolBarActionPixmap = QPixmap::fromImage(toolBarImage.copy(24*16,0,16,15));
      toolBarAction->setIcon(QIcon(toolBarActionPixmap));
      ...
      // BUTTON ID_NEXT_SONG
      toolBarAction = new QAction(parent);
      toolBarActionPixmap = QPixmap::fromImage(toolBarImage.copy(25*16,0,16,15));
      toolBarAction->setIcon(QIcon(toolBarActionPixmap));
      ...
      toolBarAction = new QAction(parent);
      toolBarActionPixmap = QPixmap::fromImage(toolBarImage.copy(27*16,0,16,15));
      toolBarAction->setIcon(QIcon(toolBarActionPixmap));
      ...
      toolBarAction = new QAction(parent);
      toolBarActionPixmap = QPixmap::fromImage(toolBarImage.copy(29*16,0,16,15));
      toolBarAction->setIcon(QIcon(toolBarActionPixmap));
