...
CNesicideProject *CNesicideProject::_instance = NULL;
...
bool CNesicideProject::exportData()
{
   ...
   QString projHdrFileName = dir.fromNativeSeparators(dir.relativeFilePath(CNesicideProject::instance()->getProjectHeaderFileName()));
