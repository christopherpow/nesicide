...
public:
   CBreakpointInfo();
   void ConstructBreakpoint ( BreakpointInfo* pBreakpoint, int type, eBreakpointItemType itemType, int event, int item1, int item1Absolute, int item2, eBreakpointConditionType conditionType, int condition, eBreakpointDataType dataType, int data, bool enabled );
   int AddBreakpoint ( BreakpointInfo* pBreakpoint );
   int AddBreakpoint ( int type, eBreakpointItemType itemType, int event, int item1, int item1Absolute, int item2, eBreakpointConditionType conditionType, int condition, eBreakpointDataType dataType, int data, bool enabled );
   void ModifyBreakpoint ( int bp, BreakpointInfo* pBreakpoint );
   void RemoveBreakpoint ( int index );
   int FindExactMatch ( int type, eBreakpointItemType itemType, int event, int item1, int item1Absolute, int item2, eBreakpointConditionType conditionType, int condition, eBreakpointDataType dataType, int data );
...
protected:
   ...
   virtual void ModifyBreakpoint ( BreakpointInfo* pBreakpoint, int type, eBreakpointItemType itemType, int event, int item1, int item1Absolute, int item2, eBreakpointConditionType conditionType, int condition, eBreakpointDataType dataType, int data, bool enabled ) = 0;
